...
int
doWrite_VAR1(u_int32_t value)
{
	return doWrite(ID_VAR1, &value);
}

int
addWrite_VAR1(u_int32_t value)
{
	return addWrite(ID_VAR1, &value);
}

int
getStatus_VAR1(void)
{
	return getStatus(ID_VAR1);
}

int
doWrite_VAR2(u_int32_t value)
{
	return doWrite(ID_VAR2, &value);
}

int
addWrite_VAR2(u_int32_t value)
{
	return addWrite(ID_VAR2, &value);
}

int
getStatus_VAR2(void)
{
	return getStatus(ID_VAR2);
}

int
doWrite_VAR3(u_int32_t value)
{
	return doWrite(ID_VAR3, &value);
}

int
addWrite_VAR3(u_int32_t value)
{
	return addWrite(ID_VAR3, &value);
}

int
getStatus_VAR3(void)
{
	return getStatus(ID_VAR3);
}
