...
int
doWrite_InputRising(int value)
{
	return doWrite(ID_InputRising, &value);
}

int
addWrite_InputRising(int value)
{
	return addWrite(ID_InputRising, &value);
}

int
getStatus_InputRising(void)
{
	return getStatus(ID_InputRising);
}

int
doWrite_InputFalling(int value)
{
	return doWrite(ID_InputFalling, &value);
}

int
addWrite_InputFalling(int value)
{
	return addWrite(ID_InputFalling, &value);
}

int
getStatus_InputFalling(void)
{
	return getStatus(ID_InputFalling);
}
