...
config.files = config/atn01.conf config/application.conf config/Crosstable.csv config/Commpar.csv config/Alarms.csv config/network0.cmg config/iomap0.cmg
