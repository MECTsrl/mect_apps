...
#include "main.h"
#include "page330.h"
#include "ui_page330.h"
#include "crosstable.h"

/**
 * @brief this macro is used to set the PAGE330 style.
 * the syntax is html stylesheet-like
 */
#define SET_PAGE330_STYLE() { \
    QString mystyle; \
 ...
 */
page330::page330(QWidget *parent) :
    page(parent),
    ui(new Ui::page330)
{
    ui->setupUi(this);
    ...
    //SET_PAGE_STYLE();
    /* set the style described into the macro SET_PAGE330_STYLE */
    SET_PAGE330_STYLE();
 ...
 */
void page330::changeEvent(QEvent * event)
{
