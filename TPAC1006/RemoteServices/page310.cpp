...
#include "main.h"
#include "page310.h"
#include "ui_page310.h"
#include "crosstable.h"

/**
 * @brief this macro is used to set the PAGE310 style.
 * the syntax is html stylesheet-like
 */
#define SET_PAGE310_STYLE() { \
    QString mystyle; \
 ...
 */
page310::page310(QWidget *parent) :
    page(parent),
    ui(new Ui::page310)
{
    ui->setupUi(this);
    ...
    //SET_PAGE_STYLE();
    /* set the style described into the macro SET_PAGE310_STYLE */
    SET_PAGE310_STYLE();
 ...
 */
void page310::changeEvent(QEvent * event)
{
