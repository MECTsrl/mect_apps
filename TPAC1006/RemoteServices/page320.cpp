...
#include "main.h"
#include "page320.h"
#include "ui_page320.h"
#include "crosstable.h"

/**
 * @brief this macro is used to set the PAGE320 style.
 * the syntax is html stylesheet-like
 */
#define SET_PAGE320_STYLE() { \
    QString mystyle; \
 ...
 */
page320::page320(QWidget *parent) :
    page(parent),
    ui(new Ui::page320)
{
    ui->setupUi(this);
    ...
    //SET_PAGE_STYLE();
    /* set the style described into the macro SET_PAGE320_STYLE */
    SET_PAGE320_STYLE();
 ...
 */
void page320::changeEvent(QEvent * event)
{
