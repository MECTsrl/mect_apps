...
#include "main.h"
#include "page340.h"
#include "ui_page340.h"
#include "crosstable.h"

/**
 * @brief this macro is used to set the PAGE340 style.
 * the syntax is html stylesheet-like
 */
#define SET_PAGE340_STYLE() { \
    QString mystyle; \
 ...
 */
page340::page340(QWidget *parent) :
    page(parent),
    ui(new Ui::page340)
{
    ui->setupUi(this);
    ...
    //SET_PAGE_STYLE();
    /* set the style described into the macro SET_PAGE340_STYLE */
    SET_PAGE340_STYLE();
 ...
 */
void page340::changeEvent(QEvent * event)
{
