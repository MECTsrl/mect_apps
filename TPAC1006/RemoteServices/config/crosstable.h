...
int getStatus_RTU_ConfAnIn_1(void);
...
int getStatus_RTU_ConfAnIn_2(void);
...
int getStatus_RTU_ConfDigIn_3(void);
...
int getStatus_RTU_ConfDigOut_4(void);
...
int getStatus_S_CAN_AnIn_1(void);
...
int getStatus_S_CAN_AnIn_2(void);
...
int getStatus_S_CAN_DigIn_3(void);
...
int getStatus_S_CAN_DigOut_4(void);
...
extern int LOC_DigIn_3;	/* Digital input 3 value */
int doWrite_LOC_DigIn_3(int value);
int addWrite_LOC_DigIn_3(int value);
int getStatus_LOC_DigIn_3(void);
...
extern int LOC_DigOut_4;	/* Digital output 4 value */
int doWrite_LOC_DigOut_4(int value);
int addWrite_LOC_DigOut_4(int value);
int getStatus_LOC_DigOut_4(void);
