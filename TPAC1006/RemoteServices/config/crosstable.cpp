...
u_int16_t RTU_ConfAnIn_1 = 0;
u_int16_t RTU_ConfAnIn_2 = 0;
int16_t RTU_AnIn_1 = 0;
int16_t RTU_AnIn_2 = 0;
int RTU_ConfDigIn_3 = 0;
int RTU_ConfDigOut_4 = 0;
int RTU_DigIn_3 = 0;
int RTU_DigOut_4 = 0;
...
int TCP_DigIn_3 = 0;
int TCP_DigOut_4 = 0;
int16_t CAN_AnIn_1 = 0;
int16_t CAN_AnIn_2 = 0;
int16_t CAN_AnIn_3 = 0;
...
int PLC_DigOut_11 = 0;
int PLC_DigOut_12 = 0;
int16_t LOC_AnIn_1 = 0;
int16_t LOC_AnIn_2 = 0;
...
{
return doWrite(ID_RTU_ConfAnIn_1,  &value);
}


int addWrite_RTU_ConfAnIn_1(u_int16_t value)
{
return addWrite(ID_RTU_ConfAnIn_1, &value);
}


int getStatus_RTU_ConfAnIn_1()
{
return getStatus(ID_RTU_ConfAnIn_1);
}


int doWrite_RTU_ConfAnIn_2(u_int16_t value)
{
return doWrite(ID_RTU_ConfAnIn_2,  &value);
}


int addWrite_RTU_ConfAnIn_2(u_int16_t value)
{
return addWrite(ID_RTU_ConfAnIn_2, &value);
}


int getStatus_RTU_ConfAnIn_2()
{
return getStatus(ID_RTU_ConfAnIn_2);
}
...
{
return doWrite(ID_RTU_ConfDigIn_3,  &value);
}


int addWrite_RTU_ConfDigIn_3(int value)
{
return addWrite(ID_RTU_ConfDigIn_3, &value);
}


int getStatus_RTU_ConfDigIn_3()
{
return getStatus(ID_RTU_ConfDigIn_3);
}


int doWrite_RTU_ConfDigOut_4(int value)
{
return doWrite(ID_RTU_ConfDigOut_4,  &value);
}


int addWrite_RTU_ConfDigOut_4(int value)
{
return addWrite(ID_RTU_ConfDigOut_4, &value);
}


int getStatus_RTU_ConfDigOut_4()
{
return getStatus(ID_RTU_ConfDigOut_4);
}
...
{
return doWrite(ID_CAN_AnIn_1,  &value);
}


int addWrite_CAN_AnIn_1(int16_t value)
{
return addWrite(ID_CAN_AnIn_1, &value);
}


int getStatus_CAN_AnIn_1()
{
return getStatus(ID_CAN_AnIn_1);
}


int doWrite_CAN_AnIn_2(int16_t value)
{
return doWrite(ID_CAN_AnIn_2,  &value);
}


int addWrite_CAN_AnIn_2(int16_t value)
{
return addWrite(ID_CAN_AnIn_2, &value);
}


int getStatus_CAN_AnIn_2()
{
return getStatus(ID_CAN_AnIn_2);
}


int doWrite_CAN_AnIn_3(int16_t value)
{
return doWrite(ID_CAN_AnIn_3,  &value);
}


int addWrite_CAN_AnIn_3(int16_t value)
{
return addWrite(ID_CAN_AnIn_3, &value);
}


int getStatus_CAN_AnIn_3()
{
return getStatus(ID_CAN_AnIn_3);
}


int doWrite_CAN_AnIn_4(int16_t value)
{
return doWrite(ID_CAN_AnIn_4,  &value);
}


int addWrite_CAN_AnIn_4(int16_t value)
{
return addWrite(ID_CAN_AnIn_4, &value);
}


int getStatus_CAN_AnIn_4()
{
return getStatus(ID_CAN_AnIn_4);
}


int doWrite_CAN_DigIn_3(int value)
{
return doWrite(ID_CAN_DigIn_3,  &value);
}


int addWrite_CAN_DigIn_3(int value)
{
return addWrite(ID_CAN_DigIn_3, &value);
}


int getStatus_CAN_DigIn_3()
{
return getStatus(ID_CAN_DigIn_3);
}


int doWrite_CAN_DigOut_4(int value)
{
return doWrite(ID_CAN_DigOut_4,  &value);
}


int addWrite_CAN_DigOut_4(int value)
{
return addWrite(ID_CAN_DigOut_4, &value);
}
...
{
return doWrite(ID_LOC_DigIn_3,  &value);
}


int addWrite_LOC_DigIn_3(int value)
{
return addWrite(ID_LOC_DigIn_3, &value);
}


int getStatus_LOC_DigIn_3()
{
return getStatus(ID_LOC_DigIn_3);
}
...
{
return doWrite(ID_LOC_DigOut_4,  &value);
}


int addWrite_LOC_DigOut_4(int value)
{
return addWrite(ID_LOC_DigOut_4, &value);
}


int getStatus_LOC_DigOut_4()
{
return getStatus(ID_LOC_DigOut_4);
}
...
{
return doWrite(ID_LOC_AnIn_1,  &value);
}


int addWrite_LOC_AnIn_1(int16_t value)
{
return addWrite(ID_LOC_AnIn_1, &value);
}


int getStatus_LOC_AnIn_1()
{
return getStatus(ID_LOC_AnIn_1);
}


int doWrite_LOC_AnIn_2(int16_t value)
{
return doWrite(ID_LOC_AnIn_2,  &value);
}


int addWrite_LOC_AnIn_2(int16_t value)
{
return addWrite(ID_LOC_AnIn_2, &value);
}


int getStatus_LOC_AnIn_2()
{
return getStatus(ID_LOC_AnIn_2);
}
...
{
int retval = 0;
retval += readFromDb(ID_RTU_ConfAnIn_1, &RTU_ConfAnIn_1);
retval += readFromDb(ID_RTU_ConfAnIn_2, &RTU_ConfAnIn_2);
retval += readFromDb(ID_RTU_AnIn_1, &RTU_AnIn_1);
retval += readFromDb(ID_RTU_AnIn_2, &RTU_AnIn_2);
retval += readFromDb(ID_RTU_ConfDigIn_3, &RTU_ConfDigIn_3);
retval += readFromDb(ID_RTU_ConfDigOut_4, &RTU_ConfDigOut_4);
...
retval += readFromDb(ID_CAN_AnIn_1, &CAN_AnIn_1);
retval += readFromDb(ID_CAN_AnIn_2, &CAN_AnIn_2);
retval += readFromDb(ID_CAN_AnIn_3, &CAN_AnIn_3);
...
retval += readFromDb(ID_LOC_DigIn_3, &LOC_DigIn_3);
...
retval += readFromDb(ID_LOC_DigOut_4, &LOC_DigOut_4);
...
retval += readFromDb(ID_LOC_AnIn_1, &LOC_AnIn_1);
retval += readFromDb(ID_LOC_AnIn_2, &LOC_AnIn_2);
