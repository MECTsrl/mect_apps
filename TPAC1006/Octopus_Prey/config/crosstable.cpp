...
/*
 * Variable PLC_EncoderLo	[ Encoder reading (LOW) ]
 */
...
/*
 * Variable PLC_EncoderHi	[ Encoder reading (HIGH) ]
 */
...
/*
 * Variable PLC_AnInConf	[ Analog inputs configuration (hex) ]
 */
...
/*
 * Variable PLC_AnOutConf	[ Analog outputs configuration (hex) ]
 */
...
/*
 * Variable PLC_EncReset	[ Encoder reset ]
 */
...
int
doWrite_PLC_EncoderLo(u_int16_t value)
{
	return doWrite(ID_PLC_EncoderLo, &value);
}

int
addWrite_PLC_EncoderLo(u_int16_t value)
{
	return addWrite(ID_PLC_EncoderLo, &value);
}

int
getStatus_PLC_EncoderLo(void)
{
	return getStatus(ID_PLC_EncoderLo);
}

int
doWrite_PLC_EncoderHi(u_int16_t value)
{
	return doWrite(ID_PLC_EncoderHi, &value);
}

int
addWrite_PLC_EncoderHi(u_int16_t value)
{
	return addWrite(ID_PLC_EncoderHi, &value);
}

int
getStatus_PLC_EncoderHi(void)
{
...
int
doWrite_PLC_AnInConf(u_int16_t value)
{
	return doWrite(ID_PLC_AnInConf, &value);
}

int
addWrite_PLC_AnInConf(u_int16_t value)
{
	return addWrite(ID_PLC_AnInConf, &value);
}

int
getStatus_PLC_AnInConf(void)
{
	return getStatus(ID_PLC_AnInConf);
}

int
doWrite_PLC_AnOutConf(u_int16_t value)
{
	return doWrite(ID_PLC_AnOutConf, &value);
}

int
addWrite_PLC_AnOutConf(u_int16_t value)
{
	return addWrite(ID_PLC_AnOutConf, &value);
}

int
getStatus_PLC_AnOutConf(void)
{
	return getStatus(ID_PLC_AnOutConf);
}

int
doWrite_PLC_EncReset(u_int16_t value)
{
	return doWrite(ID_PLC_EncReset, &value);
}

int
addWrite_PLC_EncReset(u_int16_t value)
{
	return addWrite(ID_PLC_EncReset, &value);
}

int
getStatus_PLC_EncReset(void)
{
