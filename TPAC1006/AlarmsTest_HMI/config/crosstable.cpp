...
int doWrite_Alarm_D1(int value)
{
return doWrite(ID_Alarm_D1,  &value);
}


int addWrite_Alarm_D1(int value)
{
return addWrite(ID_Alarm_D1, &value);
}


int getStatus_Alarm_D1()
{
return getStatus(ID_Alarm_D1);
}


int doWrite_Alarm_D2(int value)
{
return doWrite(ID_Alarm_D2,  &value);
}


int addWrite_Alarm_D2(int value)
{
return addWrite(ID_Alarm_D2, &value);
}


int getStatus_Alarm_D2()
{
return getStatus(ID_Alarm_D2);
}


int doWrite_Alarm_D3(int value)
{
return doWrite(ID_Alarm_D3,  &value);
}


int addWrite_Alarm_D3(int value)
{
return addWrite(ID_Alarm_D3, &value);
}


int getStatus_Alarm_D3()
{
return getStatus(ID_Alarm_D3);
}


int doWrite_Alarm_D4(int value)
{
return doWrite(ID_Alarm_D4,  &value);
}


int addWrite_Alarm_D4(int value)
{
return addWrite(ID_Alarm_D4, &value);
}


int getStatus_Alarm_D4()
{
return getStatus(ID_Alarm_D4);
}


int doWrite_Alarm_D5(int value)
{
return doWrite(ID_Alarm_D5,  &value);
}


int addWrite_Alarm_D5(int value)
{
return addWrite(ID_Alarm_D5, &value);
}


int getStatus_Alarm_D5()
{
return getStatus(ID_Alarm_D5);
}


int doWrite_Alarm_D6(int value)
{
return doWrite(ID_Alarm_D6,  &value);
}


int addWrite_Alarm_D6(int value)
{
return addWrite(ID_Alarm_D6, &value);
}


int getStatus_Alarm_D6()
{
return getStatus(ID_Alarm_D6);
}


int doWrite_Alarm_D7(int value)
{
return doWrite(ID_Alarm_D7,  &value);
}


int addWrite_Alarm_D7(int value)
{
return addWrite(ID_Alarm_D7, &value);
}


int getStatus_Alarm_D7()
{
return getStatus(ID_Alarm_D7);
}


int doWrite_Alarm_D8(int value)
{
return doWrite(ID_Alarm_D8,  &value);
}


int addWrite_Alarm_D8(int value)
{
return addWrite(ID_Alarm_D8, &value);
}


int getStatus_Alarm_D8()
{
return getStatus(ID_Alarm_D8);
}


int doWrite_Alarm_A1(int value)
{
return doWrite(ID_Alarm_A1,  &value);
}


int addWrite_Alarm_A1(int value)
{
return addWrite(ID_Alarm_A1, &value);
}


int getStatus_Alarm_A1()
{
return getStatus(ID_Alarm_A1);
}


int doWrite_Alarm_A2(int value)
{
return doWrite(ID_Alarm_A2,  &value);
}


int addWrite_Alarm_A2(int value)
{
return addWrite(ID_Alarm_A2, &value);
}


int getStatus_Alarm_A2()
{
return getStatus(ID_Alarm_A2);
}


int doWrite_Alarm_A3(int value)
{
return doWrite(ID_Alarm_A3,  &value);
}


int addWrite_Alarm_A3(int value)
{
return addWrite(ID_Alarm_A3, &value);
}


int getStatus_Alarm_A3()
{
return getStatus(ID_Alarm_A3);
}


int doWrite_Alarm_A4(int value)
{
return doWrite(ID_Alarm_A4,  &value);
}


int addWrite_Alarm_A4(int value)
{
return addWrite(ID_Alarm_A4, &value);
}


int getStatus_Alarm_A4()
{
return getStatus(ID_Alarm_A4);
}
...
{
return doWrite(ID_PLC_EncReset,  &value);
}


int addWrite_PLC_EncReset(u_int16_t value)
{
return addWrite(ID_PLC_EncReset, &value);
}


int getStatus_PLC_EncReset()
{
return getStatus(ID_PLC_EncReset);
}
...
{
int retval = 0;
retval += readFromDb(ID_Alarm_D1, &Alarm_D1);
retval += readFromDb(ID_Alarm_D2, &Alarm_D2);
retval += readFromDb(ID_Alarm_D3, &Alarm_D3);
retval += readFromDb(ID_Alarm_D4, &Alarm_D4);
retval += readFromDb(ID_Alarm_D5, &Alarm_D5);
retval += readFromDb(ID_Alarm_D6, &Alarm_D6);
retval += readFromDb(ID_Alarm_D7, &Alarm_D7);
retval += readFromDb(ID_Alarm_D8, &Alarm_D8);
retval += readFromDb(ID_Alarm_A1, &Alarm_A1);
retval += readFromDb(ID_Alarm_A2, &Alarm_A2);
retval += readFromDb(ID_Alarm_A3, &Alarm_A3);
retval += readFromDb(ID_Alarm_A4, &Alarm_A4);
...
retval += readFromDb(ID_PLC_EncReset, &PLC_EncReset);
