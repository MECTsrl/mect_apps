...
/*
 * Variable SogliaAntigelo	[ Valore di Soglia Temperatura Minima ]
 */

float SogliaAntigelo = 0;
...
/*
 * Variable is_Convettore1_ON	[ Vero se il convettore 1 è ON ]
 */

int is_Convettore1_ON = 0;
...
int
doWrite_SogliaAntigelo(float value)
{
	return doWrite(ID_SogliaAntigelo, &value);
}

int
addWrite_SogliaAntigelo(float value)
{
	return addWrite(ID_SogliaAntigelo, &value);
}

int
getStatus_SogliaAntigelo(void)
{
	return getStatus(ID_SogliaAntigelo);
}
...
int
doWrite_is_Convettore1_ON(int value)
{
	return doWrite(ID_is_Convettore1_ON, &value);
}

int
addWrite_is_Convettore1_ON(int value)
{
	return addWrite(ID_is_Convettore1_ON, &value);
}

int
getStatus_is_Convettore1_ON(void)
{
	return getStatus(ID_is_Convettore1_ON);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_SogliaAntigelo, &SogliaAntigelo);
	...
	retval += readFromDb(ID_is_Convettore1_ON, &is_Convettore1_ON);
