...
#define ID_SogliaAntigelo 1
extern float SogliaAntigelo;	/* Valore di Soglia Temperatura Minima */
int doWrite_SogliaAntigelo(float value);
int addWrite_SogliaAntigelo(float value);
int getStatus_SogliaAntigelo(void);
...
#define ID_openvpn_restart_times 207
...
#define ID_is_Convettore1_ON 211
extern int is_Convettore1_ON;	/* Vero se il convettore 1 è ON */
int doWrite_is_Convettore1_ON(int value);
int addWrite_is_Convettore1_ON(int value);
int getStatus_is_Convettore1_ON(void);
