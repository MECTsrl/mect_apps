...
/*
 * Variable SelezioneTrend	[ selezione corrente dei trend ]
 */

int32_t SelezioneTrend = 0;
...
int
doWrite_SelezioneTrend(int32_t value)
{
	return doWrite(ID_SelezioneTrend, &value);
}

int
addWrite_SelezioneTrend(int32_t value)
{
	return addWrite(ID_SelezioneTrend, &value);
}

int
getStatus_SelezioneTrend(void)
{
	return getStatus(ID_SelezioneTrend);
}
