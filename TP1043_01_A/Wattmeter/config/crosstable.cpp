...
int
doWrite_W_L1(u_int16_t value)
{
	return doWrite(ID_W_L1, &value);
}

int
addWrite_W_L1(u_int16_t value)
{
...
int
doWrite_VT_RATIO(u_int16_t value)
{
	return doWrite(ID_VT_RATIO, &value);
}

int
addWrite_VT_RATIO(u_int16_t value)
{
	return addWrite(ID_VT_RATIO, &value);
}

int
getStatus_VT_RATIO(void)
{
	return getStatus(ID_VT_RATIO);
}

int
doWrite_CT_RATIO(u_int16_t value)
{
	return doWrite(ID_CT_RATIO, &value);
}

int
addWrite_CT_RATIO(u_int16_t value)
{
	return addWrite(ID_CT_RATIO, &value);
}

int
getStatus_CT_RATIO(void)
{
