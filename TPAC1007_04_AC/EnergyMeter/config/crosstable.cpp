...
/*
 * Variable Timeout	[ Timeout Modbus ]
 */
...
/*
 * Variable Indirizzo	[ Indirizzo Modbus ]
 */

u_int16_t Indirizzo = 0;


/*
 * Variable Errore	[ Errore Registro ]
 */
...
u_int16_t unused_26 = 0;


/*
 * Variable Ttotal	[ WT1 totale Contatore energia Totale Tariffa 1 ]
 */
...
/*
 * Variable Tpart	[ WT1 parziale Contatore energia Parziale Tariffa 1 ]
 */
...
u_int16_t unused_34 = 0;


/*
 * Variable U	[ URMS phase 1 ]
 */
...
{
	return doWrite(ID_EM_Firmware, &value);
}

int
addWrite_EM_Firmware(u_int16_t value)
{
	return addWrite(ID_EM_Firmware, &value);
}

int
getStatus_EM_Firmware(void)
{
	return getStatus(ID_EM_Firmware);
}
...
int
doWrite_Timeout(u_int16_t value)
{
	return doWrite(ID_Timeout, &value);
}

int
addWrite_Timeout(u_int16_t value)
{
	return addWrite(ID_Timeout, &value);
}

int
getStatus_Timeout(void)
{
	return getStatus(ID_Timeout);
}

int
doWrite_Indirizzo(u_int16_t value)
{
	return doWrite(ID_Indirizzo, &value);
}

int
addWrite_Indirizzo(u_int16_t value)
{
	return addWrite(ID_Indirizzo, &value);
}

int
getStatus_Indirizzo(void)
{
	return getStatus(ID_Indirizzo);
}

int
doWrite_Errore(u_int16_t value)
{
	return doWrite(ID_Errore, &value);
}

int
addWrite_Errore(u_int16_t value)
{
	return addWrite(ID_Errore, &value);
}

int
getStatus_Errore(void)
{
	return getStatus(ID_Errore);
}

int
doWrite_unused_25(u_int16_t value)
{
	return doWrite(ID_unused_25, &value);
}

int
addWrite_unused_25(u_int16_t value)
{
	return addWrite(ID_unused_25, &value);
}

int
getStatus_unused_25(void)
{
	return getStatus(ID_unused_25);
}

int
doWrite_unused_26(u_int16_t value)
{
	return doWrite(ID_unused_26, &value);
}

int
addWrite_unused_26(u_int16_t value)
{
	return addWrite(ID_unused_26, &value);
}

int
getStatus_unused_26(void)
{
	return getStatus(ID_unused_26);
}

int
doWrite_Ttotal(u_int32_t value)
{
	return doWrite(ID_Ttotal, &value);
}

int
addWrite_Ttotal(u_int32_t value)
{
	return addWrite(ID_Ttotal, &value);
}

int
getStatus_Ttotal(void)
{
	return getStatus(ID_Ttotal);
}

int
doWrite_Tpart(u_int32_t value)
{
	return doWrite(ID_Tpart, &value);
}

int
addWrite_Tpart(u_int32_t value)
{
	return addWrite(ID_Tpart, &value);
}

int
getStatus_Tpart(void)
{
	return getStatus(ID_Tpart);
}

int
doWrite_unused_31(u_int16_t value)
{
	return doWrite(ID_unused_31, &value);
}

int
addWrite_unused_31(u_int16_t value)
{
	return addWrite(ID_unused_31, &value);
}

int
getStatus_unused_31(void)
{
	return getStatus(ID_unused_31);
}

int
doWrite_unused_32(u_int16_t value)
{
	return doWrite(ID_unused_32, &value);
}

int
addWrite_unused_32(u_int16_t value)
{
	return addWrite(ID_unused_32, &value);
}

int
getStatus_unused_32(void)
{
	return getStatus(ID_unused_32);
}

int
doWrite_unused_33(u_int16_t value)
{
	return doWrite(ID_unused_33, &value);
}

int
addWrite_unused_33(u_int16_t value)
{
	return addWrite(ID_unused_33, &value);
}

int
getStatus_unused_33(void)
{
	return getStatus(ID_unused_33);
}

int
doWrite_unused_34(u_int16_t value)
{
	return doWrite(ID_unused_34, &value);
}

int
addWrite_unused_34(u_int16_t value)
{
	return addWrite(ID_unused_34, &value);
}

int
getStatus_unused_34(void)
{
	return getStatus(ID_unused_34);
}

int
doWrite_U(u_int16_t value)
{
	return doWrite(ID_U, &value);
}

int
addWrite_U(u_int16_t value)
{
	return addWrite(ID_U, &value);
}

int
getStatus_U(void)
{
	return getStatus(ID_U);
}

int
doWrite_I(u_int16_t value)
{
	return doWrite(ID_I, &value);
}

int
addWrite_I(u_int16_t value)
{
	return addWrite(ID_I, &value);
}

int
getStatus_I(void)
{
	return getStatus(ID_I);
}

int
doWrite_P(u_int16_t value)
{
	return doWrite(ID_P, &value);
}

int
addWrite_P(u_int16_t value)
{
	return addWrite(ID_P, &value);
}

int
getStatus_P(void)
{
	return getStatus(ID_P);
}

int
doWrite_Q(int16_t value)
{
	return doWrite(ID_Q, &value);
}

int
addWrite_Q(int16_t value)
{
	return addWrite(ID_Q, &value);
}

int
getStatus_Q(void)
{
	return getStatus(ID_Q);
}

int
doWrite_C(int16_t value)
{
	return doWrite(ID_C, &value);
}

int
addWrite_C(int16_t value)
{
	return addWrite(ID_C, &value);
}

int
getStatus_C(void)
{
	return getStatus(ID_C);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_Indirizzo, &Indirizzo);
	retval += readFromDb(ID_Errore, &Errore);
	retval += readFromDb(ID_unused_25, &unused_25);
	retval += readFromDb(ID_unused_26, &unused_26);
	retval += readFromDb(ID_Ttotal, &Ttotal);
	retval += readFromDb(ID_Tpart, &Tpart);
	retval += readFromDb(ID_unused_31, &unused_31);
	retval += readFromDb(ID_unused_32, &unused_32);
	retval += readFromDb(ID_unused_33, &unused_33);
	retval += readFromDb(ID_unused_34, &unused_34);
	retval += readFromDb(ID_U, &U);
	retval += readFromDb(ID_I, &I);
	retval += readFromDb(ID_P, &P);
	retval += readFromDb(ID_Q, &Q);
	retval += readFromDb(ID_C, &C);
