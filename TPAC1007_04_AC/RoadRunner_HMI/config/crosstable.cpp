...
int doWrite_RisingEvent(int value)
{
return doWrite(ID_RisingEvent,  &value);
}


int addWrite_RisingEvent(int value)
{
return addWrite(ID_RisingEvent, &value);
}


int getStatus_RisingEvent()
{
return getStatus(ID_RisingEvent);
}
...
{
int retval = 0;
retval += readFromDb(ID_RisingEvent, &RisingEvent);
