...
int
doWrite_Var_1(int16_t value)
{
	return doWrite(ID_Var_1, &value);
}

int
addWrite_Var_1(int16_t value)
{
	return addWrite(ID_Var_1, &value);
}

int
getStatus_Var_1(void)
{
	return getStatus(ID_Var_1);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_Var_1, &Var_1);
