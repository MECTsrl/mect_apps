...
int doWrite_RS232_INPUT(u_int32_t value)
{
return doWrite(ID_RS232_INPUT,  &value);
}


int addWrite_RS232_INPUT(u_int32_t value)
{
return addWrite(ID_RS232_INPUT, &value);
}


int getStatus_RS232_INPUT()
{
return getStatus(ID_RS232_INPUT);
}
...
{
int retval = 0;
retval += readFromDb(ID_RS232_INPUT, &RS232_INPUT);
