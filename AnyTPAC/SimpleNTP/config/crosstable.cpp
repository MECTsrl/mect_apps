...
int
doWrite_TimeZone(int16_t value)
{
	return doWrite(ID_TimeZone, &value);
}

int
addWrite_TimeZone(int16_t value)
{
	return addWrite(ID_TimeZone, &value);
}

int
getStatus_TimeZone(void)
{
	return getStatus(ID_TimeZone);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_TimeZone, &TimeZone);
