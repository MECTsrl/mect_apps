...
#define ID_requiredItems 1
extern u_int16_t requiredItems;	/* Numero di elementi da gestire */
int doWrite_requiredItems(u_int16_t value);
int addWrite_requiredItems(u_int16_t value);
int getStatus_requiredItems(void);

#define ID_selectedItem 193
extern int16_t selectedItem;	/* Item correntemente selezionato */
int doWrite_selectedItem(int16_t value);
int addWrite_selectedItem(int16_t value);
int getStatus_selectedItem(void);
