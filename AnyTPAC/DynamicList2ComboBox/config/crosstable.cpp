...
/*
 * Variable requiredItems	[ Numero di elementi da gestire ]
 */

u_int16_t requiredItems = 0;


/*
 * Variable selectedItem	[ Item correntemente selezionato ]
 */
...
int
doWrite_requiredItems(u_int16_t value)
{
	return doWrite(ID_requiredItems, &value);
}

int
addWrite_requiredItems(u_int16_t value)
{
	return addWrite(ID_requiredItems, &value);
}

int
getStatus_requiredItems(void)
{
	return getStatus(ID_requiredItems);
}

int
doWrite_selectedItem(int16_t value)
{
	return doWrite(ID_selectedItem, &value);
}

int
addWrite_selectedItem(int16_t value)
{
	return addWrite(ID_selectedItem, &value);
}

int
getStatus_selectedItem(void)
{
	return getStatus(ID_selectedItem);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_requiredItems, &requiredItems);
	retval += readFromDb(ID_selectedItem, &selectedItem);
