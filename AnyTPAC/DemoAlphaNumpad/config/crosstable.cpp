...
int
doWrite_myInt(int16_t value)
{
	return doWrite(ID_myInt, &value);
}

int
addWrite_myInt(int16_t value)
{
	return addWrite(ID_myInt, &value);
}

int
getStatus_myInt(void)
{
	return getStatus(ID_myInt);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_myInt, &myInt);
