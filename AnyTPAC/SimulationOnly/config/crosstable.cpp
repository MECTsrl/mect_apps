...
int
doWrite_AAA(int32_t value)
{
	return doWrite(ID_AAA, &value);
}

int
addWrite_AAA(int32_t value)
{
...
int
doWrite_BBB(int32_t value)
{
	return doWrite(ID_BBB, &value);
}

int
addWrite_BBB(int32_t value)
{
...
int
doWrite_CCC(float value)
{
	return doWrite(ID_CCC, &value);
}

int
addWrite_CCC(float value)
{
...
int
doWrite_DDD(float value)
{
	return doWrite(ID_DDD, &value);
}

int
addWrite_DDD(float value)
{
