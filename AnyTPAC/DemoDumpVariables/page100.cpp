    ...
    ui(new Ui::page100)
{
    ...
    szFileForDump = "/local/root/dumpVars.bin";
    nDumpVars = 40;
}
...
void page100::on_buttonSave_clicked()
{
    if (dumpVariables(ID_HMI_1_Start_H_1, nDumpVars, szFileForDump))  {
        qDebug("Vars Dumped");
    }
    else  {
        qCritical("Error Dumping Vars");
    }
}

void page100::on_buttonLoad_clicked()
{
    if (restoreVariables(ID_HMI_1_Start_H_1, nDumpVars, szFileForDump))  {
        qDebug("Vars Restored");
    }
    else  {
        qCritical("Error Restoring Vars");
    }
}
