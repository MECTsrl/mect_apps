Purpose of this Project: Show usage of new functions introduced with Mect Suite 3.4.0
...
The result of this function is the Mect Suite version installed on taget (parsed form system file /rootfs_version)
