...
#define ID_InputRising 193
extern int InputRising;
int doWrite_InputRising(int value);
int addWrite_InputRising(int value);
int getStatus_InputRising(void);

#define ID_InputFalling 194
extern int InputFalling;
int doWrite_InputFalling(int value);
