...
int
doWrite_Auto_COMMAND(int value)
{
	return doWrite(ID_Auto_COMMAND, &value);
}

int
addWrite_Auto_COMMAND(int value)
{
	return addWrite(ID_Auto_COMMAND, &value);
}

int
getStatus_Auto_COMMAND(void)
{
