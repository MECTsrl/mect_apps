...
#define ID_Var_to_convert 193
extern int16_t Var_to_convert;
int doWrite_Var_to_convert(int16_t value);
int addWrite_Var_to_convert(int16_t value);
int getStatus_Var_to_convert(void);
