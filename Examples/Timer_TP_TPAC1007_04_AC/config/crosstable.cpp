...
/*
 * Variable Var_to_convert
 */

int16_t Var_to_convert = 0;
...
int
doWrite_Var_to_convert(int16_t value)
{
	return doWrite(ID_Var_to_convert, &value);
}

int
addWrite_Var_to_convert(int16_t value)
{
	return addWrite(ID_Var_to_convert, &value);
}

int
getStatus_Var_to_convert(void)
{
	return getStatus(ID_Var_to_convert);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_Var_to_convert, &Var_to_convert);
