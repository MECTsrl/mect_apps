...
#define ID_Byte_1 1
extern u_int8_t Byte_1;
int doWrite_Byte_1(u_int8_t value);
int addWrite_Byte_1(u_int8_t value);
int getStatus_Byte_1(void);

#define ID_Byte_2 2
extern u_int8_t Byte_2;
int doWrite_Byte_2(u_int8_t value);
int addWrite_Byte_2(u_int8_t value);
int getStatus_Byte_2(void);

#define ID_Byte_3 3
extern u_int8_t Byte_3;
int doWrite_Byte_3(u_int8_t value);
int addWrite_Byte_3(u_int8_t value);
int getStatus_Byte_3(void);

#define ID_Byte_4 4
extern u_int8_t Byte_4;
int doWrite_Byte_4(u_int8_t value);
int addWrite_Byte_4(u_int8_t value);
int getStatus_Byte_4(void);

#define ID_Byte_5 5
extern u_int8_t Byte_5;
int doWrite_Byte_5(u_int8_t value);
int addWrite_Byte_5(u_int8_t value);
int getStatus_Byte_5(void);

#define ID_Byte_6 6
extern u_int8_t Byte_6;
int doWrite_Byte_6(u_int8_t value);
int addWrite_Byte_6(u_int8_t value);
int getStatus_Byte_6(void);

#define ID_Byte_7 7
extern u_int8_t Byte_7;
int doWrite_Byte_7(u_int8_t value);
int addWrite_Byte_7(u_int8_t value);
int getStatus_Byte_7(void);

#define ID_Byte_8 8
extern u_int8_t Byte_8;
int doWrite_Byte_8(u_int8_t value);
int addWrite_Byte_8(u_int8_t value);
int getStatus_Byte_8(void);

#define ID_Byte_9 9
extern u_int8_t Byte_9;
int doWrite_Byte_9(u_int8_t value);
int addWrite_Byte_9(u_int8_t value);
int getStatus_Byte_9(void);

#define ID_Byte_10 10
extern u_int8_t Byte_10;
int doWrite_Byte_10(u_int8_t value);
int addWrite_Byte_10(u_int8_t value);
int getStatus_Byte_10(void);

#define ID_Flag_UpdateTCP 193
extern int16_t Flag_UpdateTCP;	/* Flag for write the code via PC */
int doWrite_Flag_UpdateTCP(int16_t value);
int addWrite_Flag_UpdateTCP(int16_t value);
int getStatus_Flag_UpdateTCP(void);
