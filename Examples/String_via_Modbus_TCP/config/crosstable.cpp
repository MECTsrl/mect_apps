...
/*
 * Variable Flag_UpdateTCP	[ Flag for write the code via PC ]
 */

int16_t Flag_UpdateTCP = 0;
...
int
doWrite_Byte_1(u_int8_t value)
{
	return doWrite(ID_Byte_1, &value);
}

int
addWrite_Byte_1(u_int8_t value)
{
	return addWrite(ID_Byte_1, &value);
}

int
getStatus_Byte_1(void)
{
	return getStatus(ID_Byte_1);
}

int
doWrite_Byte_2(u_int8_t value)
{
	return doWrite(ID_Byte_2, &value);
}

int
addWrite_Byte_2(u_int8_t value)
{
	return addWrite(ID_Byte_2, &value);
}

int
getStatus_Byte_2(void)
{
	return getStatus(ID_Byte_2);
}

int
doWrite_Byte_3(u_int8_t value)
{
	return doWrite(ID_Byte_3, &value);
}

int
addWrite_Byte_3(u_int8_t value)
{
	return addWrite(ID_Byte_3, &value);
}

int
getStatus_Byte_3(void)
{
	return getStatus(ID_Byte_3);
}

int
doWrite_Byte_4(u_int8_t value)
{
	return doWrite(ID_Byte_4, &value);
}

int
addWrite_Byte_4(u_int8_t value)
{
	return addWrite(ID_Byte_4, &value);
}

int
getStatus_Byte_4(void)
{
	return getStatus(ID_Byte_4);
}

int
doWrite_Byte_5(u_int8_t value)
{
	return doWrite(ID_Byte_5, &value);
}

int
addWrite_Byte_5(u_int8_t value)
{
	return addWrite(ID_Byte_5, &value);
}

int
getStatus_Byte_5(void)
{
	return getStatus(ID_Byte_5);
}

int
doWrite_Byte_6(u_int8_t value)
{
	return doWrite(ID_Byte_6, &value);
}

int
addWrite_Byte_6(u_int8_t value)
{
	return addWrite(ID_Byte_6, &value);
}

int
getStatus_Byte_6(void)
{
	return getStatus(ID_Byte_6);
}

int
doWrite_Byte_7(u_int8_t value)
{
	return doWrite(ID_Byte_7, &value);
}

int
addWrite_Byte_7(u_int8_t value)
{
	return addWrite(ID_Byte_7, &value);
}

int
getStatus_Byte_7(void)
{
	return getStatus(ID_Byte_7);
}

int
doWrite_Byte_8(u_int8_t value)
{
	return doWrite(ID_Byte_8, &value);
}

int
addWrite_Byte_8(u_int8_t value)
{
	return addWrite(ID_Byte_8, &value);
}

int
getStatus_Byte_8(void)
{
	return getStatus(ID_Byte_8);
}

int
doWrite_Byte_9(u_int8_t value)
{
	return doWrite(ID_Byte_9, &value);
}

int
addWrite_Byte_9(u_int8_t value)
{
	return addWrite(ID_Byte_9, &value);
}

int
getStatus_Byte_9(void)
{
	return getStatus(ID_Byte_9);
}

int
doWrite_Byte_10(u_int8_t value)
{
	return doWrite(ID_Byte_10, &value);
}

int
addWrite_Byte_10(u_int8_t value)
{
	return addWrite(ID_Byte_10, &value);
}

int
getStatus_Byte_10(void)
{
	return getStatus(ID_Byte_10);
}

int
doWrite_Flag_UpdateTCP(int16_t value)
{
	return doWrite(ID_Flag_UpdateTCP, &value);
}

int
addWrite_Flag_UpdateTCP(int16_t value)
{
	return addWrite(ID_Flag_UpdateTCP, &value);
}

int
getStatus_Flag_UpdateTCP(void)
{
	return getStatus(ID_Flag_UpdateTCP);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_Byte_1, &Byte_1);
	retval += readFromDb(ID_Byte_2, &Byte_2);
	retval += readFromDb(ID_Byte_3, &Byte_3);
	retval += readFromDb(ID_Byte_4, &Byte_4);
	retval += readFromDb(ID_Byte_5, &Byte_5);
	retval += readFromDb(ID_Byte_6, &Byte_6);
	retval += readFromDb(ID_Byte_7, &Byte_7);
	retval += readFromDb(ID_Byte_8, &Byte_8);
	retval += readFromDb(ID_Byte_9, &Byte_9);
	retval += readFromDb(ID_Byte_10, &Byte_10);
	retval += readFromDb(ID_Flag_UpdateTCP, &Flag_UpdateTCP);
