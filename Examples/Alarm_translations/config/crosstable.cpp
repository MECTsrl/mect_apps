...
/*
 * Variable Tipo_Lingua	[ 0=IT - 1=EN - retentive value for alarm translation at boot ]
 */

int16_t Tipo_Lingua = 0;


/*
 * Variable Allarme_Tmax_P	[ Tempo massimo - riscaldamento P ]
 */

int Allarme_Tmax_P = 0;


/*
 * Variable Allarme_Tmax_C	[ Tempo massimo - riscaldamento C ]
 */

int Allarme_Tmax_C = 0;
...
int
doWrite_Tipo_Lingua(int16_t value)
{
	return doWrite(ID_Tipo_Lingua, &value);
}

int
addWrite_Tipo_Lingua(int16_t value)
{
	return addWrite(ID_Tipo_Lingua, &value);
}

int
getStatus_Tipo_Lingua(void)
{
	return getStatus(ID_Tipo_Lingua);
}

int
doWrite_Allarme_Tmax_P(int value)
{
	return doWrite(ID_Allarme_Tmax_P, &value);
}

int
addWrite_Allarme_Tmax_P(int value)
{
	return addWrite(ID_Allarme_Tmax_P, &value);
}

int
getStatus_Allarme_Tmax_P(void)
{
	return getStatus(ID_Allarme_Tmax_P);
}

int
doWrite_Allarme_Tmax_C(int value)
{
	return doWrite(ID_Allarme_Tmax_C, &value);
}

int
addWrite_Allarme_Tmax_C(int value)
{
	return addWrite(ID_Allarme_Tmax_C, &value);
}

int
getStatus_Allarme_Tmax_C(void)
{
	return getStatus(ID_Allarme_Tmax_C);
}

int
doWrite_Tmax_P(float value)
{
	return doWrite(ID_Tmax_P, &value);
}

int
addWrite_Tmax_P(float value)
{
	return addWrite(ID_Tmax_P, &value);
}

int
getStatus_Tmax_P(void)
{
	return getStatus(ID_Tmax_P);
}

int
doWrite_Tmax_C(float value)
{
	return doWrite(ID_Tmax_C, &value);
}

int
addWrite_Tmax_C(float value)
{
	return addWrite(ID_Tmax_C, &value);
}

int
getStatus_Tmax_C(void)
{
	return getStatus(ID_Tmax_C);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_Tipo_Lingua, &Tipo_Lingua);
	retval += readFromDb(ID_Allarme_Tmax_P, &Allarme_Tmax_P);
	retval += readFromDb(ID_Allarme_Tmax_C, &Allarme_Tmax_C);
	retval += readFromDb(ID_Tmax_P, &Tmax_P);
	retval += readFromDb(ID_Tmax_C, &Tmax_C);
