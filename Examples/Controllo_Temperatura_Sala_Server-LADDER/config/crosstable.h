...
#define ID_Pwd_Fabb 1
extern u_int32_t Pwd_Fabb;
int doWrite_Pwd_Fabb(u_int32_t value);
int addWrite_Pwd_Fabb(u_int32_t value);
int getStatus_Pwd_Fabb(void);

#define ID_SP_Temperatura_Soglia_Estate 2
extern float SP_Temperatura_Soglia_Estate;
int doWrite_SP_Temperatura_Soglia_Estate(float value);
int addWrite_SP_Temperatura_Soglia_Estate(float value);
int getStatus_SP_Temperatura_Soglia_Estate(void);

#define ID_Controllo_Generico_Attivo 193
extern int Controllo_Generico_Attivo;	/* Dipende dalla fascia oraria */
int doWrite_Controllo_Generico_Attivo(int value);
int addWrite_Controllo_Generico_Attivo(int value);
int getStatus_Controllo_Generico_Attivo(void);

#define ID_Minuti_Attuali 194
extern u_int16_t Minuti_Attuali;	/* ora attuale convertita in minuti */
int doWrite_Minuti_Attuali(u_int16_t value);
int addWrite_Minuti_Attuali(u_int16_t value);
int getStatus_Minuti_Attuali(void);

#define ID_Minuti_Start_Fascia_1 195
extern u_int16_t Minuti_Start_Fascia_1;
int doWrite_Minuti_Start_Fascia_1(u_int16_t value);
int addWrite_Minuti_Start_Fascia_1(u_int16_t value);
int getStatus_Minuti_Start_Fascia_1(void);

#define ID_Minuti_Stop_Fascia_1 196
extern u_int16_t Minuti_Stop_Fascia_1;
int doWrite_Minuti_Stop_Fascia_1(u_int16_t value);
int addWrite_Minuti_Stop_Fascia_1(u_int16_t value);
int getStatus_Minuti_Stop_Fascia_1(void);

#define ID_Minuti_Start_Fascia_2 197
extern u_int16_t Minuti_Start_Fascia_2;
int doWrite_Minuti_Start_Fascia_2(u_int16_t value);
int addWrite_Minuti_Start_Fascia_2(u_int16_t value);
int getStatus_Minuti_Start_Fascia_2(void);

#define ID_Minuti_Stop_Fascia_2 198
extern u_int16_t Minuti_Stop_Fascia_2;
int doWrite_Minuti_Stop_Fascia_2(u_int16_t value);
int addWrite_Minuti_Stop_Fascia_2(u_int16_t value);
int getStatus_Minuti_Stop_Fascia_2(void);

#define ID_Minuti_Start_Fascia_3 199
extern u_int16_t Minuti_Start_Fascia_3;
int doWrite_Minuti_Start_Fascia_3(u_int16_t value);
int addWrite_Minuti_Start_Fascia_3(u_int16_t value);
int getStatus_Minuti_Start_Fascia_3(void);

#define ID_Minuti_Stop_Fascia_3 200
extern u_int16_t Minuti_Stop_Fascia_3;
int doWrite_Minuti_Stop_Fascia_3(u_int16_t value);
int addWrite_Minuti_Stop_Fascia_3(u_int16_t value);
int getStatus_Minuti_Stop_Fascia_3(void);

#define ID_Enable_Allarme_Temp_Iniziale 202
extern int Enable_Allarme_Temp_Iniziale;	/* flag di allarme attivo solo una volta e dopo 20min dallo start */
int doWrite_Enable_Allarme_Temp_Iniziale(int value);
int addWrite_Enable_Allarme_Temp_Iniziale(int value);
int getStatus_Enable_Allarme_Temp_Iniziale(void);

#define ID_Enable_Allarme_Temp 203
extern int Enable_Allarme_Temp;	/* flag di allarme di ciclo e dopo i 20 min */
int doWrite_Enable_Allarme_Temp(int value);
int addWrite_Enable_Allarme_Temp(int value);
int getStatus_Enable_Allarme_Temp(void);

#define ID_Enable_Allarme_Temp_Max 204
extern int Enable_Allarme_Temp_Max;	/* flag di allarme MASSIMO SEMPRE ATTIVO */
int doWrite_Enable_Allarme_Temp_Max(int value);
int addWrite_Enable_Allarme_Temp_Max(int value);
int getStatus_Enable_Allarme_Temp_Max(void);

#define ID_Allarme_Temp_Iniziale 206
extern int Allarme_Temp_Iniziale;	/* Allarme temperatura a 20 minuti */
int doWrite_Allarme_Temp_Iniziale(int value);
int addWrite_Allarme_Temp_Iniziale(int value);
int getStatus_Allarme_Temp_Iniziale(void);

#define ID_Allarme_Temperatura 207
extern int Allarme_Temperatura;	/* Allarme temperatura in fascia attiva */
int doWrite_Allarme_Temperatura(int value);
int addWrite_Allarme_Temperatura(int value);
int getStatus_Allarme_Temperatura(void);

#define ID_Allarme_Temp_Massima 208
extern int Allarme_Temp_Massima;	/* Allarme temperatura massima */
int doWrite_Allarme_Temp_Massima(int value);
int addWrite_Allarme_Temp_Massima(int value);
int getStatus_Allarme_Temp_Massima(void);

#define ID_View_Icona_Allarme 210
extern int View_Icona_Allarme;
int doWrite_View_Icona_Allarme(int value);
int addWrite_View_Icona_Allarme(int value);
int getStatus_View_Icona_Allarme(void);

#define ID_Temperatura_1 212
extern float Temperatura_1;	/* Temperatura convertita da int a real per uniformita e grafici */
int doWrite_Temperatura_1(float value);
int addWrite_Temperatura_1(float value);
int getStatus_Temperatura_1(void);
