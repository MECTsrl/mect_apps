...
u_int32_t Pwd_Fabb = 0;


/*
 * Variable SP_Temperatura_Soglia_Estate
 */

float SP_Temperatura_Soglia_Estate = 0;


/*
 * Variable Controllo_Generico_Attivo	[ Dipende dalla fascia oraria ]
 */

int Controllo_Generico_Attivo = 0;


/*
 * Variable Minuti_Attuali	[ ora attuale convertita in minuti ]
 */

u_int16_t Minuti_Attuali = 0;


/*
 * Variable Minuti_Start_Fascia_1
 */

u_int16_t Minuti_Start_Fascia_1 = 0;


/*
 * Variable Minuti_Stop_Fascia_1
 */

u_int16_t Minuti_Stop_Fascia_1 = 0;


/*
 * Variable Minuti_Start_Fascia_2
 */

u_int16_t Minuti_Start_Fascia_2 = 0;


/*
 * Variable Minuti_Stop_Fascia_2
 */

u_int16_t Minuti_Stop_Fascia_2 = 0;


/*
 * Variable Minuti_Start_Fascia_3
 */

u_int16_t Minuti_Start_Fascia_3 = 0;


/*
 * Variable Minuti_Stop_Fascia_3
 */

u_int16_t Minuti_Stop_Fascia_3 = 0;


/*
 * Variable Enable_Allarme_Temp_Iniziale	[ flag di allarme attivo solo una volta e dopo 20min dallo start ]
 */

int Enable_Allarme_Temp_Iniziale = 0;


/*
 * Variable Enable_Allarme_Temp	[ flag di allarme di ciclo e dopo i 20 min ]
 */

int Enable_Allarme_Temp = 0;


/*
 * Variable Enable_Allarme_Temp_Max	[ flag di allarme MASSIMO SEMPRE ATTIVO ]
 */

int Enable_Allarme_Temp_Max = 0;


/*
 * Variable Allarme_Temp_Iniziale	[ Allarme temperatura a 20 minuti ]
 */

int Allarme_Temp_Iniziale = 0;


/*
 * Variable Allarme_Temperatura	[ Allarme temperatura in fascia attiva ]
 */

int Allarme_Temperatura = 0;


/*
 * Variable Allarme_Temp_Massima	[ Allarme temperatura massima ]
 */

int Allarme_Temp_Massima = 0;


/*
 * Variable View_Icona_Allarme
 */

int View_Icona_Allarme = 0;


/*
 * Variable Temperatura_1	[ Temperatura convertita da int a real per uniformita e grafici ]
 */
...
int
doWrite_Pwd_Fabb(u_int32_t value)
{
	return doWrite(ID_Pwd_Fabb, &value);
}

int
addWrite_Pwd_Fabb(u_int32_t value)
{
	return addWrite(ID_Pwd_Fabb, &value);
}

int
getStatus_Pwd_Fabb(void)
{
	return getStatus(ID_Pwd_Fabb);
}

int
doWrite_SP_Temperatura_Soglia_Estate(float value)
{
	return doWrite(ID_SP_Temperatura_Soglia_Estate, &value);
}

int
addWrite_SP_Temperatura_Soglia_Estate(float value)
{
	return addWrite(ID_SP_Temperatura_Soglia_Estate, &value);
}

int
getStatus_SP_Temperatura_Soglia_Estate(void)
{
	return getStatus(ID_SP_Temperatura_Soglia_Estate);
}

int
doWrite_Controllo_Generico_Attivo(int value)
{
	return doWrite(ID_Controllo_Generico_Attivo, &value);
}

int
addWrite_Controllo_Generico_Attivo(int value)
{
	return addWrite(ID_Controllo_Generico_Attivo, &value);
}

int
getStatus_Controllo_Generico_Attivo(void)
{
	return getStatus(ID_Controllo_Generico_Attivo);
}

int
doWrite_Minuti_Attuali(u_int16_t value)
{
	return doWrite(ID_Minuti_Attuali, &value);
}

int
addWrite_Minuti_Attuali(u_int16_t value)
{
	return addWrite(ID_Minuti_Attuali, &value);
}

int
getStatus_Minuti_Attuali(void)
{
	return getStatus(ID_Minuti_Attuali);
}

int
doWrite_Minuti_Start_Fascia_1(u_int16_t value)
{
	return doWrite(ID_Minuti_Start_Fascia_1, &value);
}

int
addWrite_Minuti_Start_Fascia_1(u_int16_t value)
{
	return addWrite(ID_Minuti_Start_Fascia_1, &value);
}

int
getStatus_Minuti_Start_Fascia_1(void)
{
	return getStatus(ID_Minuti_Start_Fascia_1);
}

int
doWrite_Minuti_Stop_Fascia_1(u_int16_t value)
{
	return doWrite(ID_Minuti_Stop_Fascia_1, &value);
}

int
addWrite_Minuti_Stop_Fascia_1(u_int16_t value)
{
	return addWrite(ID_Minuti_Stop_Fascia_1, &value);
}

int
getStatus_Minuti_Stop_Fascia_1(void)
{
	return getStatus(ID_Minuti_Stop_Fascia_1);
}

int
doWrite_Minuti_Start_Fascia_2(u_int16_t value)
{
	return doWrite(ID_Minuti_Start_Fascia_2, &value);
}

int
addWrite_Minuti_Start_Fascia_2(u_int16_t value)
{
	return addWrite(ID_Minuti_Start_Fascia_2, &value);
}

int
getStatus_Minuti_Start_Fascia_2(void)
{
	return getStatus(ID_Minuti_Start_Fascia_2);
}

int
doWrite_Minuti_Stop_Fascia_2(u_int16_t value)
{
	return doWrite(ID_Minuti_Stop_Fascia_2, &value);
}

int
addWrite_Minuti_Stop_Fascia_2(u_int16_t value)
{
	return addWrite(ID_Minuti_Stop_Fascia_2, &value);
}

int
getStatus_Minuti_Stop_Fascia_2(void)
{
	return getStatus(ID_Minuti_Stop_Fascia_2);
}

int
doWrite_Minuti_Start_Fascia_3(u_int16_t value)
{
	return doWrite(ID_Minuti_Start_Fascia_3, &value);
}

int
addWrite_Minuti_Start_Fascia_3(u_int16_t value)
{
	return addWrite(ID_Minuti_Start_Fascia_3, &value);
}

int
getStatus_Minuti_Start_Fascia_3(void)
{
	return getStatus(ID_Minuti_Start_Fascia_3);
}

int
doWrite_Minuti_Stop_Fascia_3(u_int16_t value)
{
	return doWrite(ID_Minuti_Stop_Fascia_3, &value);
}

int
addWrite_Minuti_Stop_Fascia_3(u_int16_t value)
{
	return addWrite(ID_Minuti_Stop_Fascia_3, &value);
}

int
getStatus_Minuti_Stop_Fascia_3(void)
{
	return getStatus(ID_Minuti_Stop_Fascia_3);
}

int
doWrite_Enable_Allarme_Temp_Iniziale(int value)
{
	return doWrite(ID_Enable_Allarme_Temp_Iniziale, &value);
}

int
addWrite_Enable_Allarme_Temp_Iniziale(int value)
{
	return addWrite(ID_Enable_Allarme_Temp_Iniziale, &value);
}

int
getStatus_Enable_Allarme_Temp_Iniziale(void)
{
	return getStatus(ID_Enable_Allarme_Temp_Iniziale);
}

int
doWrite_Enable_Allarme_Temp(int value)
{
	return doWrite(ID_Enable_Allarme_Temp, &value);
}

int
addWrite_Enable_Allarme_Temp(int value)
{
	return addWrite(ID_Enable_Allarme_Temp, &value);
}

int
getStatus_Enable_Allarme_Temp(void)
{
	return getStatus(ID_Enable_Allarme_Temp);
}

int
doWrite_Enable_Allarme_Temp_Max(int value)
{
	return doWrite(ID_Enable_Allarme_Temp_Max, &value);
}

int
addWrite_Enable_Allarme_Temp_Max(int value)
{
	return addWrite(ID_Enable_Allarme_Temp_Max, &value);
}

int
getStatus_Enable_Allarme_Temp_Max(void)
{
	return getStatus(ID_Enable_Allarme_Temp_Max);
}

int
doWrite_Allarme_Temp_Iniziale(int value)
{
	return doWrite(ID_Allarme_Temp_Iniziale, &value);
}

int
addWrite_Allarme_Temp_Iniziale(int value)
{
	return addWrite(ID_Allarme_Temp_Iniziale, &value);
}

int
getStatus_Allarme_Temp_Iniziale(void)
{
	return getStatus(ID_Allarme_Temp_Iniziale);
}

int
doWrite_Allarme_Temperatura(int value)
{
	return doWrite(ID_Allarme_Temperatura, &value);
}

int
addWrite_Allarme_Temperatura(int value)
{
	return addWrite(ID_Allarme_Temperatura, &value);
}

int
getStatus_Allarme_Temperatura(void)
{
	return getStatus(ID_Allarme_Temperatura);
}

int
doWrite_Allarme_Temp_Massima(int value)
{
	return doWrite(ID_Allarme_Temp_Massima, &value);
}

int
addWrite_Allarme_Temp_Massima(int value)
{
	return addWrite(ID_Allarme_Temp_Massima, &value);
}

int
getStatus_Allarme_Temp_Massima(void)
{
	return getStatus(ID_Allarme_Temp_Massima);
}

int
doWrite_View_Icona_Allarme(int value)
{
	return doWrite(ID_View_Icona_Allarme, &value);
}

int
addWrite_View_Icona_Allarme(int value)
{
	return addWrite(ID_View_Icona_Allarme, &value);
}

int
getStatus_View_Icona_Allarme(void)
{
	return getStatus(ID_View_Icona_Allarme);
}

int
doWrite_Temperatura_1(float value)
{
	return doWrite(ID_Temperatura_1, &value);
}

int
addWrite_Temperatura_1(float value)
{
	return addWrite(ID_Temperatura_1, &value);
}

int
getStatus_Temperatura_1(void)
{
	return getStatus(ID_Temperatura_1);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_Pwd_Fabb, &Pwd_Fabb);
	retval += readFromDb(ID_SP_Temperatura_Soglia_Estate, &SP_Temperatura_Soglia_Estate);
	retval += readFromDb(ID_Controllo_Generico_Attivo, &Controllo_Generico_Attivo);
	retval += readFromDb(ID_Minuti_Attuali, &Minuti_Attuali);
	retval += readFromDb(ID_Minuti_Start_Fascia_1, &Minuti_Start_Fascia_1);
	retval += readFromDb(ID_Minuti_Stop_Fascia_1, &Minuti_Stop_Fascia_1);
	retval += readFromDb(ID_Minuti_Start_Fascia_2, &Minuti_Start_Fascia_2);
	retval += readFromDb(ID_Minuti_Stop_Fascia_2, &Minuti_Stop_Fascia_2);
	retval += readFromDb(ID_Minuti_Start_Fascia_3, &Minuti_Start_Fascia_3);
	retval += readFromDb(ID_Minuti_Stop_Fascia_3, &Minuti_Stop_Fascia_3);
	retval += readFromDb(ID_Enable_Allarme_Temp_Iniziale, &Enable_Allarme_Temp_Iniziale);
	retval += readFromDb(ID_Enable_Allarme_Temp, &Enable_Allarme_Temp);
	retval += readFromDb(ID_Enable_Allarme_Temp_Max, &Enable_Allarme_Temp_Max);
	retval += readFromDb(ID_Allarme_Temp_Iniziale, &Allarme_Temp_Iniziale);
	retval += readFromDb(ID_Allarme_Temperatura, &Allarme_Temperatura);
	retval += readFromDb(ID_Allarme_Temp_Massima, &Allarme_Temp_Massima);
	retval += readFromDb(ID_View_Icona_Allarme, &View_Icona_Allarme);
	retval += readFromDb(ID_Temperatura_1, &Temperatura_1);
