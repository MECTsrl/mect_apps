...
/*
 * Variable MQTT_Broker	[ MQTT_Broker connected ]
 */
...
/*
 * Variable MQTT_ActiveTopic	[ MQTT Topic active ]
 */

int MQTT_ActiveTopic = 0;


/*
 * Variable MQTT_Status	[ Stato Connessione MQTT (significato simile ai Nodi Modbus) ]
 */

int16_t MQTT_Status = 0;


/*
 * Variable MQTT_mid	[ MQTT Message Id of a sent message confirmed from Broker (QOS=2) ]
 */

u_int32_t MQTT_mid = 0;


/*
 * Variable MQTT_LastConnection	[ Uptime Seconds of last Connection ]
 */

u_int32_t MQTT_LastConnection = 0;


/*
 * Variable MQTT_LastDisconnection	[ Uptime Seconds of last Disconnection ]
 */

u_int32_t MQTT_LastDisconnection = 0;
...
int
doWrite_MQTT_Broker(int value)
{
	return doWrite(ID_MQTT_Broker, &value);
}

int
addWrite_MQTT_Broker(int value)
{
	return addWrite(ID_MQTT_Broker, &value);
}

int
getStatus_MQTT_Broker(void)
{
	return getStatus(ID_MQTT_Broker);
}

int
doWrite_MQTT_ActiveTopic(int value)
{
	return doWrite(ID_MQTT_ActiveTopic, &value);
}

int
addWrite_MQTT_ActiveTopic(int value)
{
	return addWrite(ID_MQTT_ActiveTopic, &value);
}

int
getStatus_MQTT_ActiveTopic(void)
{
	return getStatus(ID_MQTT_ActiveTopic);
}

int
doWrite_MQTT_Status(int16_t value)
{
	return doWrite(ID_MQTT_Status, &value);
}

int
addWrite_MQTT_Status(int16_t value)
{
	return addWrite(ID_MQTT_Status, &value);
}

int
getStatus_MQTT_Status(void)
{
	return getStatus(ID_MQTT_Status);
}

int
doWrite_MQTT_mid(u_int32_t value)
{
	return doWrite(ID_MQTT_mid, &value);
}

int
addWrite_MQTT_mid(u_int32_t value)
{
	return addWrite(ID_MQTT_mid, &value);
}

int
getStatus_MQTT_mid(void)
{
	return getStatus(ID_MQTT_mid);
}

int
doWrite_MQTT_LastConnection(u_int32_t value)
{
	return doWrite(ID_MQTT_LastConnection, &value);
}

int
addWrite_MQTT_LastConnection(u_int32_t value)
{
	return addWrite(ID_MQTT_LastConnection, &value);
}

int
getStatus_MQTT_LastConnection(void)
{
	return getStatus(ID_MQTT_LastConnection);
}

int
doWrite_MQTT_LastDisconnection(u_int32_t value)
{
	return doWrite(ID_MQTT_LastDisconnection, &value);
}

int
addWrite_MQTT_LastDisconnection(u_int32_t value)
{
	return addWrite(ID_MQTT_LastDisconnection, &value);
}

int
getStatus_MQTT_LastDisconnection(void)
{
	return getStatus(ID_MQTT_LastDisconnection);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_MQTT_Broker, &MQTT_Broker);
	retval += readFromDb(ID_MQTT_ActiveTopic, &MQTT_ActiveTopic);
	retval += readFromDb(ID_MQTT_Status, &MQTT_Status);
	retval += readFromDb(ID_MQTT_mid, &MQTT_mid);
	retval += readFromDb(ID_MQTT_LastConnection, &MQTT_LastConnection);
	retval += readFromDb(ID_MQTT_LastDisconnection, &MQTT_LastDisconnection);
