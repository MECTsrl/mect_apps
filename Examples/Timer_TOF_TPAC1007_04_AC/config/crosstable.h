...
#define ID_Int_time 193
extern int16_t Int_time;	/* integer type  variable to be converted into time type variable */
int doWrite_Int_time(int16_t value);
int addWrite_Int_time(int16_t value);
int getStatus_Int_time(void);
