...
/*
 * Variable Int_time	[ integer type  variable to be converted into time type variable ]
 */
...
int
doWrite_Int_time(int16_t value)
{
	return doWrite(ID_Int_time, &value);
}

int
addWrite_Int_time(int16_t value)
{
	return addWrite(ID_Int_time, &value);
}

int
getStatus_Int_time(void)
{
	return getStatus(ID_Int_time);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_Int_time, &Int_time);
