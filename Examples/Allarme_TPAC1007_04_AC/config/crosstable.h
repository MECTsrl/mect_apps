...
#define ID_SetPoint_temp 1
extern float SetPoint_temp;
int doWrite_SetPoint_temp(float value);
int addWrite_SetPoint_temp(float value);
int getStatus_SetPoint_temp(void);

#define ID_Start 2
extern int Start;
int doWrite_Start(int value);
int addWrite_Start(int value);
int getStatus_Start(void);

#define ID_Average_AnInp1 194
extern float Average_AnInp1;
int doWrite_Average_AnInp1(float value);
int addWrite_Average_AnInp1(float value);
int getStatus_Average_AnInp1(void);

#define ID_Alarm_temp 195
extern int Alarm_temp;	/* Temperature alarm - Analog input 1 */
int doWrite_Alarm_temp(int value);
int addWrite_Alarm_temp(int value);
int getStatus_Alarm_temp(void);
