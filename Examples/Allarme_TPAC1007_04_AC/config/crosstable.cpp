...
/*
 * Variable Average_AnInp1
 */

float Average_AnInp1 = 0;


/*
 * Variable Alarm_temp	[ Temperature alarm - Analog input 1 ]
 */
...
int
doWrite_SetPoint_temp(float value)
{
	return doWrite(ID_SetPoint_temp, &value);
}

int
addWrite_SetPoint_temp(float value)
{
	return addWrite(ID_SetPoint_temp, &value);
}

int
getStatus_SetPoint_temp(void)
{
	return getStatus(ID_SetPoint_temp);
}

int
doWrite_Start(int value)
{
	return doWrite(ID_Start, &value);
}

int
addWrite_Start(int value)
{
	return addWrite(ID_Start, &value);
}

int
getStatus_Start(void)
{
	return getStatus(ID_Start);
}

int
doWrite_Average_AnInp1(float value)
{
	return doWrite(ID_Average_AnInp1, &value);
}

int
addWrite_Average_AnInp1(float value)
{
	return addWrite(ID_Average_AnInp1, &value);
}

int
getStatus_Average_AnInp1(void)
{
	return getStatus(ID_Average_AnInp1);
}

int
doWrite_Alarm_temp(int value)
{
	return doWrite(ID_Alarm_temp, &value);
}

int
addWrite_Alarm_temp(int value)
{
	return addWrite(ID_Alarm_temp, &value);
}

int
getStatus_Alarm_temp(void)
{
	return getStatus(ID_Alarm_temp);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_SetPoint_temp, &SetPoint_temp);
	retval += readFromDb(ID_Start, &Start);
	retval += readFromDb(ID_Average_AnInp1, &Average_AnInp1);
	retval += readFromDb(ID_Alarm_temp, &Alarm_temp);
