...
/*
 * Variable Set_Temperature	[ Set point temperature ]
 */
...
/*
 * Variable Set_Temperature_SelfTun	[ Self tuning set point temperature ]
 */

float Set_Temperature_SelfTun = 0;
...
/*
 * Variable KP_SelfTuning
 */

float KP_SelfTuning = 0;


/*
 * Variable KI_SelfTuning
 */

float KI_SelfTuning = 0;


/*
 * Variable KD_SelfTuning
 */

float KD_SelfTuning = 0;


/*
 * Variable Cutback_SelfTuning
 */

float Cutback_SelfTuning = 0;


/*
 * Variable Start_sw	[ Start process ]
 */
...
/*
 * Variable Automatic_Mode	[ 0 = Manuale - 1 = Automatic ]
 */
...
/*
 * Variable ManualCommandOut_1
 */

int ManualCommandOut_1 = 0;


/*
 * Variable Start_Self_Tuning
 */

int Start_Self_Tuning = 0;
...
int
doWrite_Set_Temperature(float value)
{
	return doWrite(ID_Set_Temperature, &value);
}

int
addWrite_Set_Temperature(float value)
{
	return addWrite(ID_Set_Temperature, &value);
}

int
getStatus_Set_Temperature(void)
{
	return getStatus(ID_Set_Temperature);
}

int
doWrite_Set_Temperature_SelfTun(float value)
{
	return doWrite(ID_Set_Temperature_SelfTun, &value);
}

int
addWrite_Set_Temperature_SelfTun(float value)
{
	return addWrite(ID_Set_Temperature_SelfTun, &value);
}

int
getStatus_Set_Temperature_SelfTun(void)
{
	return getStatus(ID_Set_Temperature_SelfTun);
}

int
doWrite_KP(float value)
{
	return doWrite(ID_KP, &value);
}

int
addWrite_KP(float value)
{
	return addWrite(ID_KP, &value);
}

int
getStatus_KP(void)
{
	return getStatus(ID_KP);
}

int
doWrite_KI(float value)
{
	return doWrite(ID_KI, &value);
}

int
addWrite_KI(float value)
{
	return addWrite(ID_KI, &value);
}

int
getStatus_KI(void)
{
	return getStatus(ID_KI);
}

int
doWrite_KD(float value)
{
	return doWrite(ID_KD, &value);
}

int
addWrite_KD(float value)
{
	return addWrite(ID_KD, &value);
}

int
getStatus_KD(void)
{
	return getStatus(ID_KD);
}

int
doWrite_Cutback(float value)
{
	return doWrite(ID_Cutback, &value);
}

int
addWrite_Cutback(float value)
{
	return addWrite(ID_Cutback, &value);
}

int
getStatus_Cutback(void)
{
	return getStatus(ID_Cutback);
}

int
doWrite_KP_SelfTuning(float value)
{
	return doWrite(ID_KP_SelfTuning, &value);
}

int
addWrite_KP_SelfTuning(float value)
{
	return addWrite(ID_KP_SelfTuning, &value);
}

int
getStatus_KP_SelfTuning(void)
{
	return getStatus(ID_KP_SelfTuning);
}

int
doWrite_KI_SelfTuning(float value)
{
	return doWrite(ID_KI_SelfTuning, &value);
}

int
addWrite_KI_SelfTuning(float value)
{
	return addWrite(ID_KI_SelfTuning, &value);
}

int
getStatus_KI_SelfTuning(void)
{
	return getStatus(ID_KI_SelfTuning);
}

int
doWrite_KD_SelfTuning(float value)
{
	return doWrite(ID_KD_SelfTuning, &value);
}

int
addWrite_KD_SelfTuning(float value)
{
	return addWrite(ID_KD_SelfTuning, &value);
}

int
getStatus_KD_SelfTuning(void)
{
	return getStatus(ID_KD_SelfTuning);
}

int
doWrite_Cutback_SelfTuning(float value)
{
	return doWrite(ID_Cutback_SelfTuning, &value);
}

int
addWrite_Cutback_SelfTuning(float value)
{
	return addWrite(ID_Cutback_SelfTuning, &value);
}

int
getStatus_Cutback_SelfTuning(void)
{
	return getStatus(ID_Cutback_SelfTuning);
}

int
doWrite_Start_sw(int value)
{
	return doWrite(ID_Start_sw, &value);
}

int
addWrite_Start_sw(int value)
{
	return addWrite(ID_Start_sw, &value);
}

int
getStatus_Start_sw(void)
{
	return getStatus(ID_Start_sw);
}

int
doWrite_Automatic_Mode(int value)
{
	return doWrite(ID_Automatic_Mode, &value);
}

int
addWrite_Automatic_Mode(int value)
{
	return addWrite(ID_Automatic_Mode, &value);
}

int
getStatus_Automatic_Mode(void)
{
	return getStatus(ID_Automatic_Mode);
}

int
doWrite_ManualCommandOut_1(int value)
{
	return doWrite(ID_ManualCommandOut_1, &value);
}

int
addWrite_ManualCommandOut_1(int value)
{
	return addWrite(ID_ManualCommandOut_1, &value);
}

int
getStatus_ManualCommandOut_1(void)
{
	return getStatus(ID_ManualCommandOut_1);
}

int
doWrite_Start_Self_Tuning(int value)
{
	return doWrite(ID_Start_Self_Tuning, &value);
}

int
addWrite_Start_Self_Tuning(int value)
{
	return addWrite(ID_Start_Self_Tuning, &value);
}

int
getStatus_Start_Self_Tuning(void)
{
	return getStatus(ID_Start_Self_Tuning);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_Set_Temperature, &Set_Temperature);
	retval += readFromDb(ID_Set_Temperature_SelfTun, &Set_Temperature_SelfTun);
	retval += readFromDb(ID_KP, &KP);
	retval += readFromDb(ID_KI, &KI);
	retval += readFromDb(ID_KD, &KD);
	retval += readFromDb(ID_Cutback, &Cutback);
	retval += readFromDb(ID_KP_SelfTuning, &KP_SelfTuning);
	retval += readFromDb(ID_KI_SelfTuning, &KI_SelfTuning);
	retval += readFromDb(ID_KD_SelfTuning, &KD_SelfTuning);
	retval += readFromDb(ID_Cutback_SelfTuning, &Cutback_SelfTuning);
	retval += readFromDb(ID_Start_sw, &Start_sw);
	retval += readFromDb(ID_Automatic_Mode, &Automatic_Mode);
	retval += readFromDb(ID_ManualCommandOut_1, &ManualCommandOut_1);
	retval += readFromDb(ID_Start_Self_Tuning, &Start_Self_Tuning);
