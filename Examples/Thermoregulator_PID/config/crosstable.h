...
#define ID_Set_Temperature 1
extern float Set_Temperature;	/* Set point temperature */
int doWrite_Set_Temperature(float value);
int addWrite_Set_Temperature(float value);
int getStatus_Set_Temperature(void);

#define ID_Set_Temperature_SelfTun 2
extern float Set_Temperature_SelfTun;	/* Self tuning set point temperature */
int doWrite_Set_Temperature_SelfTun(float value);
int addWrite_Set_Temperature_SelfTun(float value);
int getStatus_Set_Temperature_SelfTun(void);

#define ID_KP 3
extern float KP;
int doWrite_KP(float value);
int addWrite_KP(float value);
int getStatus_KP(void);

#define ID_KI 4
extern float KI;
int doWrite_KI(float value);
int addWrite_KI(float value);
int getStatus_KI(void);

#define ID_KD 5
extern float KD;
int doWrite_KD(float value);
int addWrite_KD(float value);
int getStatus_KD(void);

#define ID_Cutback 6
extern float Cutback;
int doWrite_Cutback(float value);
int addWrite_Cutback(float value);
int getStatus_Cutback(void);

#define ID_KP_SelfTuning 7
extern float KP_SelfTuning;
int doWrite_KP_SelfTuning(float value);
int addWrite_KP_SelfTuning(float value);
int getStatus_KP_SelfTuning(void);

#define ID_KI_SelfTuning 8
extern float KI_SelfTuning;
int doWrite_KI_SelfTuning(float value);
int addWrite_KI_SelfTuning(float value);
int getStatus_KI_SelfTuning(void);

#define ID_KD_SelfTuning 9
extern float KD_SelfTuning;
int doWrite_KD_SelfTuning(float value);
int addWrite_KD_SelfTuning(float value);
int getStatus_KD_SelfTuning(void);

#define ID_Cutback_SelfTuning 10
extern float Cutback_SelfTuning;
int doWrite_Cutback_SelfTuning(float value);
int addWrite_Cutback_SelfTuning(float value);
int getStatus_Cutback_SelfTuning(void);

#define ID_Start_sw 193
extern int Start_sw;	/* Start process */
int doWrite_Start_sw(int value);
int addWrite_Start_sw(int value);
int getStatus_Start_sw(void);

#define ID_Automatic_Mode 194
extern int Automatic_Mode;	/* 0 = Manuale - 1 = Automatic */
int doWrite_Automatic_Mode(int value);
int addWrite_Automatic_Mode(int value);
int getStatus_Automatic_Mode(void);

#define ID_ManualCommandOut_1 195
extern int ManualCommandOut_1;
int doWrite_ManualCommandOut_1(int value);
int addWrite_ManualCommandOut_1(int value);
int getStatus_ManualCommandOut_1(void);

#define ID_Start_Self_Tuning 196
extern int Start_Self_Tuning;
int doWrite_Start_Self_Tuning(int value);
int addWrite_Start_Self_Tuning(int value);
int getStatus_Start_Self_Tuning(void);
