...
void page200::on_atcmButton_SelfTuning_clicked(bool checked)
{
    if(checked){
        doWrite_KD_SelfTuning(0);
        doWrite_KI_SelfTuning(0);
        doWrite_KP_SelfTuning(0);
        doWrite_Cutback_SelfTuning(0);
    }
}
