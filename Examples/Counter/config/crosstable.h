...
int doWrite_Count(int16_t value);
int addWrite_Count(int16_t value);
int getStatus_Count(void);

#define ID_Rising_edge 194
extern float Rising_edge;
int doWrite_Rising_edge(float value);
int addWrite_Rising_edge(float value);
int getStatus_Rising_edge(void);

#define ID_Falling_edge 195
extern float Falling_edge;
int doWrite_Falling_edge(float value);
int addWrite_Falling_edge(float value);
int getStatus_Falling_edge(void);

#define ID_Elapsed_time 196
extern float Elapsed_time;
int doWrite_Elapsed_time(float value);
int addWrite_Elapsed_time(float value);
int getStatus_Elapsed_time(void);
