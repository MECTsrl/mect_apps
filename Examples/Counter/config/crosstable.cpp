...
int
doWrite_Count(int16_t value)
{
	return doWrite(ID_Count, &value);
}

int
addWrite_Count(int16_t value)
{
	return addWrite(ID_Count, &value);
}

int
getStatus_Count(void)
{
	return getStatus(ID_Count);
}

int
doWrite_Rising_edge(float value)
{
	return doWrite(ID_Rising_edge, &value);
}

int
addWrite_Rising_edge(float value)
{
	return addWrite(ID_Rising_edge, &value);
}

int
getStatus_Rising_edge(void)
{
	return getStatus(ID_Rising_edge);
}

int
doWrite_Falling_edge(float value)
{
	return doWrite(ID_Falling_edge, &value);
}

int
addWrite_Falling_edge(float value)
{
	return addWrite(ID_Falling_edge, &value);
}

int
getStatus_Falling_edge(void)
{
	return getStatus(ID_Falling_edge);
}

int
doWrite_Elapsed_time(float value)
{
	return doWrite(ID_Elapsed_time, &value);
}

int
addWrite_Elapsed_time(float value)
{
	return addWrite(ID_Elapsed_time, &value);
}

int
getStatus_Elapsed_time(void)
{
	return getStatus(ID_Elapsed_time);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_Count, &Count);
	retval += readFromDb(ID_Rising_edge, &Rising_edge);
	retval += readFromDb(ID_Falling_edge, &Falling_edge);
	retval += readFromDb(ID_Elapsed_time, &Elapsed_time);
