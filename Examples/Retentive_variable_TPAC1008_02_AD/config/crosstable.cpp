...
/*
 * Variable Retentive_DigVal
 */

int Retentive_DigVal = 0;


/*
 * Variable Retentive_AnVal
 */

int16_t Retentive_AnVal = 0;
...
int
doWrite_Retentive_DigVal(int value)
{
	return doWrite(ID_Retentive_DigVal, &value);
}

int
addWrite_Retentive_DigVal(int value)
{
	return addWrite(ID_Retentive_DigVal, &value);
}

int
getStatus_Retentive_DigVal(void)
{
	return getStatus(ID_Retentive_DigVal);
}

int
doWrite_Retentive_AnVal(int16_t value)
{
	return doWrite(ID_Retentive_AnVal, &value);
}

int
addWrite_Retentive_AnVal(int16_t value)
{
	return addWrite(ID_Retentive_AnVal, &value);
}

int
getStatus_Retentive_AnVal(void)
{
	return getStatus(ID_Retentive_AnVal);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_Retentive_DigVal, &Retentive_DigVal);
	retval += readFromDb(ID_Retentive_AnVal, &Retentive_AnVal);
