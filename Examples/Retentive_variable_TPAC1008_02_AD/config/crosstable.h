...
#define ID_Retentive_DigVal 1
extern int Retentive_DigVal;
int doWrite_Retentive_DigVal(int value);
int addWrite_Retentive_DigVal(int value);
int getStatus_Retentive_DigVal(void);

#define ID_Retentive_AnVal 2
extern int16_t Retentive_AnVal;
int doWrite_Retentive_AnVal(int16_t value);
int addWrite_Retentive_AnVal(int16_t value);
int getStatus_Retentive_AnVal(void);
