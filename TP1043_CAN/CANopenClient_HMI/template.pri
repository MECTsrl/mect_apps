...
config.files = config/atn01.conf config/application.conf config/Crosstable.csv config/Commpar.csv config/Alarms.csv config/iomap1.cmg config/network1.cmg
