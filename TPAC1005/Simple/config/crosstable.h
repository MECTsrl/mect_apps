...
#define ID_Usb0_Status 193
extern int16_t Usb0_Status;	/* Stato Porta USB 0 */
int doWrite_Usb0_Status(int16_t value);
int addWrite_Usb0_Status(int16_t value);
int getStatus_Usb0_Status(void);

#define ID_Usb1_Status 194
extern int16_t Usb1_Status;	/* Stato Porta USB 1 */
int doWrite_Usb1_Status(int16_t value);
int addWrite_Usb1_Status(int16_t value);
int getStatus_Usb1_Status(void);

#define ID_SDCard_Status 195
extern int16_t SDCard_Status;	/* Stato SD Card */
int doWrite_SDCard_Status(int16_t value);
int addWrite_SDCard_Status(int16_t value);
int getStatus_SDCard_Status(void);

#define ID_Buzzer_Repeat 196
extern u_int8_t Buzzer_Repeat;	/* Numero_Ripetizioni */
int doWrite_Buzzer_Repeat(u_int8_t value);
int addWrite_Buzzer_Repeat(u_int8_t value);
int getStatus_Buzzer_Repeat(void);

#define ID_Buzzer_Off_Time 197
extern u_int8_t Buzzer_Off_Time;	/* Buzzer off time in 0.01 sec */
int doWrite_Buzzer_Off_Time(u_int8_t value);
int addWrite_Buzzer_Off_Time(u_int8_t value);
int getStatus_Buzzer_Off_Time(void);

#define ID_Buzzer_On_Time 198
extern u_int8_t Buzzer_On_Time;	/* Buzzer on time in 0.01 sec */
int doWrite_Buzzer_On_Time(u_int8_t value);
int addWrite_Buzzer_On_Time(u_int8_t value);
int getStatus_Buzzer_On_Time(void);
