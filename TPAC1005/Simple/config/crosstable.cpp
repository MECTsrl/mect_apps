...
/*
 * Variable Usb0_Status	[ Stato Porta USB 0 ]
 */

int16_t Usb0_Status = 0;


/*
 * Variable Usb1_Status	[ Stato Porta USB 1 ]
 */

int16_t Usb1_Status = 0;


/*
 * Variable SDCard_Status	[ Stato SD Card ]
 */

int16_t SDCard_Status = 0;


/*
 * Variable Buzzer_Repeat	[ Numero_Ripetizioni ]
 */

u_int8_t Buzzer_Repeat = 0;


/*
 * Variable Buzzer_Off_Time	[ Buzzer off time in 0.01 sec ]
 */

u_int8_t Buzzer_Off_Time = 0;


/*
 * Variable Buzzer_On_Time	[ Buzzer on time in 0.01 sec ]
 */

u_int8_t Buzzer_On_Time = 0;
...
int
doWrite_Usb0_Status(int16_t value)
{
	return doWrite(ID_Usb0_Status, &value);
}

int
addWrite_Usb0_Status(int16_t value)
{
	return addWrite(ID_Usb0_Status, &value);
}

int
getStatus_Usb0_Status(void)
{
	return getStatus(ID_Usb0_Status);
}

int
doWrite_Usb1_Status(int16_t value)
{
	return doWrite(ID_Usb1_Status, &value);
}

int
addWrite_Usb1_Status(int16_t value)
{
	return addWrite(ID_Usb1_Status, &value);
}

int
getStatus_Usb1_Status(void)
{
	return getStatus(ID_Usb1_Status);
}

int
doWrite_SDCard_Status(int16_t value)
{
	return doWrite(ID_SDCard_Status, &value);
}

int
addWrite_SDCard_Status(int16_t value)
{
	return addWrite(ID_SDCard_Status, &value);
}

int
getStatus_SDCard_Status(void)
{
	return getStatus(ID_SDCard_Status);
}

int
doWrite_Buzzer_Repeat(u_int8_t value)
{
	return doWrite(ID_Buzzer_Repeat, &value);
}

int
addWrite_Buzzer_Repeat(u_int8_t value)
{
	return addWrite(ID_Buzzer_Repeat, &value);
}

int
getStatus_Buzzer_Repeat(void)
{
	return getStatus(ID_Buzzer_Repeat);
}

int
doWrite_Buzzer_Off_Time(u_int8_t value)
{
	return doWrite(ID_Buzzer_Off_Time, &value);
}

int
addWrite_Buzzer_Off_Time(u_int8_t value)
{
	return addWrite(ID_Buzzer_Off_Time, &value);
}

int
getStatus_Buzzer_Off_Time(void)
{
	return getStatus(ID_Buzzer_Off_Time);
}

int
doWrite_Buzzer_On_Time(u_int8_t value)
{
	return doWrite(ID_Buzzer_On_Time, &value);
}

int
addWrite_Buzzer_On_Time(u_int8_t value)
{
	return addWrite(ID_Buzzer_On_Time, &value);
}

int
getStatus_Buzzer_On_Time(void)
{
	return getStatus(ID_Buzzer_On_Time);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_Usb0_Status, &Usb0_Status);
	retval += readFromDb(ID_Usb1_Status, &Usb1_Status);
	retval += readFromDb(ID_SDCard_Status, &SDCard_Status);
	retval += readFromDb(ID_Buzzer_Repeat, &Buzzer_Repeat);
	retval += readFromDb(ID_Buzzer_Off_Time, &Buzzer_Off_Time);
	retval += readFromDb(ID_Buzzer_On_Time, &Buzzer_On_Time);
