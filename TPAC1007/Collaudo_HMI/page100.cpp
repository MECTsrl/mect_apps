...
void page100::updateData()
{
    ...
    if (ui->atcmButton_2->isChecked()) {
        if (counter < 0) { // was idle
            counter = 0;
            prepareWriteVar("PLC_DigDir_1", &one, NULL);
            prepareWriteVar("PLC_DigDir_2", &one, NULL);
            prepareWriteVar("PLC_DigDir_3", &one, NULL);
            prepareWriteVar("PLC_DigDir_4", &one, NULL);
            prepareWriteVar("PLC_DigDir_5", &one, NULL);
            prepareWriteVar("PLC_DigDir_6", &one, NULL);
            prepareWriteVar("PLC_DigDir_7", &one, NULL);
            prepareWriteVar("PLC_DigDir_8", &one, NULL);
            writePendingInorder();
        } else {
            counter = (++counter) % (16);
                switch (counter) {
        ...
        if (counter >= 0) { // was running
            ...
            prepareWriteVar("PLC_DigDir_1", &zero, NULL);
            prepareWriteVar("PLC_DigDir_2", &zero, NULL);
            prepareWriteVar("PLC_DigDir_3", &zero, NULL);
            prepareWriteVar("PLC_DigDir_4", &zero, NULL);
            prepareWriteVar("PLC_DigDir_5", &zero, NULL);
            prepareWriteVar("PLC_DigDir_6", &zero, NULL);
            prepareWriteVar("PLC_DigDir_7", &zero, NULL);
            prepareWriteVar("PLC_DigDir_8", &zero, NULL);
            writePendingInorder();
        }
    }
}
