...
int getStatus_RTU_RTU1_WR(void);
...
extern u_int32_t PLC_HeartBeat;	/* Life time TPLC050 device */
int doWrite_PLC_HeartBeat(u_int32_t value);
int addWrite_PLC_HeartBeat(u_int32_t value);
int getStatus_PLC_HeartBeat(void);

#define ID_PLC_ColdJunctionT 5301
extern int16_t PLC_ColdJunctionT;	/* Cold junction temperature value */
int doWrite_PLC_ColdJunctionT(int16_t value);
int addWrite_PLC_ColdJunctionT(int16_t value);
int getStatus_PLC_ColdJunctionT(void);

#define ID_PLC_Reboot 5302
extern int16_t PLC_Reboot;	/* TPLC050 chain reboot */
int doWrite_PLC_Reboot(int16_t value);
int addWrite_PLC_Reboot(int16_t value);
int getStatus_PLC_Reboot(void);

#define ID_PLC_ModulesNumber 5303
extern u_int16_t PLC_ModulesNumber;	/* Number of modules */
int doWrite_PLC_ModulesNumber(u_int16_t value);
int addWrite_PLC_ModulesNumber(u_int16_t value);
int getStatus_PLC_ModulesNumber(void);

#define ID_PLC_AnInConf_1 5304
extern u_int16_t PLC_AnInConf_1;	/* Analog input 1 configuration TPLC050 */
int doWrite_PLC_AnInConf_1(u_int16_t value);
int addWrite_PLC_AnInConf_1(u_int16_t value);
int getStatus_PLC_AnInConf_1(void);

#define ID_PLC_AnInConf_2 5305
extern u_int16_t PLC_AnInConf_2;	/* Analog input 2 configuration TPLC050 */
int doWrite_PLC_AnInConf_2(u_int16_t value);
int addWrite_PLC_AnInConf_2(u_int16_t value);
int getStatus_PLC_AnInConf_2(void);

#define ID_PLC_AnIn_1 5306
extern int16_t PLC_AnIn_1;	/* Analog input 1 value TPLC050 */
int doWrite_PLC_AnIn_1(int16_t value);
int addWrite_PLC_AnIn_1(int16_t value);
int getStatus_PLC_AnIn_1(void);

#define ID_PLC_AnIn_2 5307
extern int16_t PLC_AnIn_2;	/* Analog input 2 value TPLC050 */
int doWrite_PLC_AnIn_2(int16_t value);
int addWrite_PLC_AnIn_2(int16_t value);
int getStatus_PLC_AnIn_2(void);

#define ID_PLC_DigDir_1 5308
extern int PLC_DigDir_1;	/* Digital IO 1 configuration TPLC050 */
int doWrite_PLC_DigDir_1(int value);
int addWrite_PLC_DigDir_1(int value);
int getStatus_PLC_DigDir_1(void);

#define ID_PLC_DigDir_2 5309
extern int PLC_DigDir_2;	/* Digital IO 2 configuration TPLC050 */
int doWrite_PLC_DigDir_2(int value);
int addWrite_PLC_DigDir_2(int value);
int getStatus_PLC_DigDir_2(void);

#define ID_PLC_DigDir_3 5310
extern int PLC_DigDir_3;	/* Digital IO 3 configuration TPLC050 */
int doWrite_PLC_DigDir_3(int value);
int addWrite_PLC_DigDir_3(int value);
int getStatus_PLC_DigDir_3(void);

#define ID_PLC_DigDir_4 5311
extern int PLC_DigDir_4;	/* Digital IO 4 configuration TPLC050 */
int doWrite_PLC_DigDir_4(int value);
int addWrite_PLC_DigDir_4(int value);
int getStatus_PLC_DigDir_4(void);

#define ID_PLC_DigDir_5 5312
extern int PLC_DigDir_5;	/* Digital IO 5 configuration TPLC050 */
int doWrite_PLC_DigDir_5(int value);
int addWrite_PLC_DigDir_5(int value);
int getStatus_PLC_DigDir_5(void);

#define ID_PLC_DigDir_6 5313
extern int PLC_DigDir_6;	/* Digital IO 6 configuration TPLC050 */
int doWrite_PLC_DigDir_6(int value);
int addWrite_PLC_DigDir_6(int value);
int getStatus_PLC_DigDir_6(void);

#define ID_PLC_DigDir_7 5314
extern int PLC_DigDir_7;	/* Digital IO 7 configuration TPLC050 */
int doWrite_PLC_DigDir_7(int value);
int addWrite_PLC_DigDir_7(int value);
int getStatus_PLC_DigDir_7(void);

#define ID_PLC_DigDir_8 5315
extern int PLC_DigDir_8;	/* Digital IO 8 configuration TPLC050 */
...
extern int PLC_DigIn_1;	/* Digital input 1 value TPLC050 */
...
extern int PLC_DigIn_2;	/* Digital input 2 value TPLC050 */
...
extern int PLC_DigIn_3;	/* Digital input 3 value TPLC050 */
...
extern int PLC_DigIn_4;	/* Digital input 4 value TPLC050 */
...
extern int PLC_DigIn_5;	/* Digital input 5 value TPLC050 */
...
extern int PLC_DigIn_6;	/* Digital input 6 value TPLC050 */
...
extern int PLC_DigIn_7;	/* Digital input 7 value TPLC050 */
...
extern int PLC_DigIn_8;	/* Digital input 8 value TPLC050 */
int doWrite_PLC_DigIn_8(int value);
int addWrite_PLC_DigIn_8(int value);
int getStatus_PLC_DigIn_8(void);

#define ID_PLC_DigOut_1 5324
extern int PLC_DigOut_1;	/* Digital output 1 value TPLC050 */
int doWrite_PLC_DigOut_1(int value);
int addWrite_PLC_DigOut_1(int value);
int getStatus_PLC_DigOut_1(void);

#define ID_PLC_DigOut_2 5325
extern int PLC_DigOut_2;	/* Digital output 2 value TPLC050 */
int doWrite_PLC_DigOut_2(int value);
int addWrite_PLC_DigOut_2(int value);
int getStatus_PLC_DigOut_2(void);

#define ID_PLC_DigOut_3 5326
extern int PLC_DigOut_3;	/* Digital output 3 value TPLC050 */
int doWrite_PLC_DigOut_3(int value);
int addWrite_PLC_DigOut_3(int value);
int getStatus_PLC_DigOut_3(void);

#define ID_PLC_DigOut_4 5327
extern int PLC_DigOut_4;	/* Digital output 4 value TPLC050 */
int doWrite_PLC_DigOut_4(int value);
int addWrite_PLC_DigOut_4(int value);
int getStatus_PLC_DigOut_4(void);

#define ID_PLC_DigOut_5 5328
extern int PLC_DigOut_5;	/* Digital output 5 value TPLC050 */
int doWrite_PLC_DigOut_5(int value);
int addWrite_PLC_DigOut_5(int value);
int getStatus_PLC_DigOut_5(void);

#define ID_PLC_DigOut_6 5329
extern int PLC_DigOut_6;	/* Digital output 6 value TPLC050 */
int doWrite_PLC_DigOut_6(int value);
int addWrite_PLC_DigOut_6(int value);
int getStatus_PLC_DigOut_6(void);

#define ID_PLC_DigOut_7 5330
extern int PLC_DigOut_7;	/* Digital output 7 value TPLC050 */
int doWrite_PLC_DigOut_7(int value);
int addWrite_PLC_DigOut_7(int value);
int getStatus_PLC_DigOut_7(void);

#define ID_PLC_DigOut_8 5331
extern int PLC_DigOut_8;	/* Digital output 8 value TPLC050 */
int doWrite_PLC_DigOut_8(int value);
int addWrite_PLC_DigOut_8(int value);
int getStatus_PLC_DigOut_8(void);

#define ID_PLC_AnInFltr_1 5332
extern u_int16_t PLC_AnInFltr_1;	/* Analog input filter 1 TPLC050 */
int doWrite_PLC_AnInFltr_1(u_int16_t value);
int addWrite_PLC_AnInFltr_1(u_int16_t value);
int getStatus_PLC_AnInFltr_1(void);

#define ID_PLC_AnInFltr_2 5333
extern u_int16_t PLC_AnInFltr_2;	/* Analog input filter 2 TPLC050 */
int doWrite_PLC_AnInFltr_2(u_int16_t value);
int addWrite_PLC_AnInFltr_2(u_int16_t value);
int getStatus_PLC_AnInFltr_2(void);

#define ID_PLC_FirmwareVer 5334
extern u_int16_t PLC_FirmwareVer;	/* Firmware release TPLC050 */
int doWrite_PLC_FirmwareVer(u_int16_t value);
int addWrite_PLC_FirmwareVer(u_int16_t value);
int getStatus_PLC_FirmwareVer(void);

#define ID_PLC_HWconfig 5335
extern u_int16_t PLC_HWconfig;	/* Firmware release TPLC050 */
int doWrite_PLC_HWconfig(u_int16_t value);
int addWrite_PLC_HWconfig(u_int16_t value);
int getStatus_PLC_HWconfig(void);

#define ID_PLC_StatusWord 5336
extern u_int16_t PLC_StatusWord;	/* Status word TPLC050 */
int doWrite_PLC_StatusWord(u_int16_t value);
int addWrite_PLC_StatusWord(u_int16_t value);
int getStatus_PLC_StatusWord(void);

#define ID_PLC_EncoderCounter 5337
extern u_int32_t PLC_EncoderCounter;
int doWrite_PLC_EncoderCounter(u_int32_t value);
int addWrite_PLC_EncoderCounter(u_int32_t value);
int getStatus_PLC_EncoderCounter(void);

#define ID_PLC_EnableEncoder 5338
extern u_int16_t PLC_EnableEncoder;
int doWrite_PLC_EnableEncoder(u_int16_t value);
int addWrite_PLC_EnableEncoder(u_int16_t value);
int getStatus_PLC_EnableEncoder(void);

#define ID_PLC_ResetCounter 5339
extern u_int32_t PLC_ResetCounter;
int doWrite_PLC_ResetCounter(u_int32_t value);
int addWrite_PLC_ResetCounter(u_int32_t value);
int getStatus_PLC_ResetCounter(void);
