...
#define ID_RTU_DigDir_3 197
extern int RTU_DigDir_3;
int doWrite_RTU_DigDir_3(int value);
int addWrite_RTU_DigDir_3(int value);
int getStatus_RTU_DigDir_3(void);

#define ID_RTU_DigDir_4 198
extern int RTU_DigDir_4;
int doWrite_RTU_DigDir_4(int value);
int addWrite_RTU_DigDir_4(int value);
int getStatus_RTU_DigDir_4(void);
...
int getStatus_S_LOC_AnIn_1(void);

#define ID_S_LOC_AnIn_2 222
extern int16_t S_LOC_AnIn_2;
int doWrite_S_LOC_AnIn_2(int16_t value);
int addWrite_S_LOC_AnIn_2(int16_t value);
int getStatus_S_LOC_AnIn_2(void);

#define ID_S_LOC_DigIn_3 223
extern u_int16_t S_LOC_DigIn_3;
int doWrite_S_LOC_DigIn_3(u_int16_t value);
int addWrite_S_LOC_DigIn_3(u_int16_t value);
int getStatus_S_LOC_DigIn_3(void);

#define ID_S_LOC_DigOut_4 224
extern u_int16_t S_LOC_DigOut_4;
int doWrite_S_LOC_DigOut_4(u_int16_t value);
int addWrite_S_LOC_DigOut_4(u_int16_t value);
int getStatus_S_LOC_DigOut_4(void);

#define ID_S_RTU_AnIn_1 225
extern int16_t S_RTU_AnIn_1;
int doWrite_S_RTU_AnIn_1(int16_t value);
int addWrite_S_RTU_AnIn_1(int16_t value);
int getStatus_S_RTU_AnIn_1(void);

#define ID_S_RTU_AnIn_2 226
extern int16_t S_RTU_AnIn_2;
int doWrite_S_RTU_AnIn_2(int16_t value);
int addWrite_S_RTU_AnIn_2(int16_t value);
int getStatus_S_RTU_AnIn_2(void);

#define ID_S_RTU_DigIn_3 227
extern u_int16_t S_RTU_DigIn_3;
int doWrite_S_RTU_DigIn_3(u_int16_t value);
int addWrite_S_RTU_DigIn_3(u_int16_t value);
int getStatus_S_RTU_DigIn_3(void);

#define ID_S_RTU_DigOut_4 228
extern u_int16_t S_RTU_DigOut_4;
int doWrite_S_RTU_DigOut_4(u_int16_t value);
int addWrite_S_RTU_DigOut_4(u_int16_t value);
int getStatus_S_RTU_DigOut_4(void);

#define ID_S_RTUbis_AnIn_1 229
extern int16_t S_RTUbis_AnIn_1;
int doWrite_S_RTUbis_AnIn_1(int16_t value);
int addWrite_S_RTUbis_AnIn_1(int16_t value);
int getStatus_S_RTUbis_AnIn_1(void);

#define ID_S_RTUbis_AnIn_2 230
extern int16_t S_RTUbis_AnIn_2;
int doWrite_S_RTUbis_AnIn_2(int16_t value);
int addWrite_S_RTUbis_AnIn_2(int16_t value);
int getStatus_S_RTUbis_AnIn_2(void);

#define ID_S_RTUbis_DigIn_3 231
extern u_int16_t S_RTUbis_DigIn_3;
int doWrite_S_RTUbis_DigIn_3(u_int16_t value);
int addWrite_S_RTUbis_DigIn_3(u_int16_t value);
int getStatus_S_RTUbis_DigIn_3(void);

#define ID_S_RTUbisDigOut_4 232
extern u_int16_t S_RTUbisDigOut_4;
int doWrite_S_RTUbisDigOut_4(u_int16_t value);
int addWrite_S_RTUbisDigOut_4(u_int16_t value);
int getStatus_S_RTUbisDigOut_4(void);

#define ID_S_TCP_AnIn_1 233
extern int16_t S_TCP_AnIn_1;
int doWrite_S_TCP_AnIn_1(int16_t value);
int addWrite_S_TCP_AnIn_1(int16_t value);
int getStatus_S_TCP_AnIn_1(void);

#define ID_S_TCP_AnIn_2 234
extern int16_t S_TCP_AnIn_2;
int doWrite_S_TCP_AnIn_2(int16_t value);
int addWrite_S_TCP_AnIn_2(int16_t value);
int getStatus_S_TCP_AnIn_2(void);

#define ID_S_TCP_DigIn_3 235
extern u_int16_t S_TCP_DigIn_3;
int doWrite_S_TCP_DigIn_3(u_int16_t value);
int addWrite_S_TCP_DigIn_3(u_int16_t value);
int getStatus_S_TCP_DigIn_3(void);

#define ID_S_TCP_DigOut_4 236
