...
{
return writeVarByCtIndex(ID_PLC_DigIn_17,  &value);
}


int addWrite_PLC_DigIn_17(int value)
{
return (prepareWriteVarByCtIndex(ID_PLC_DigIn_17, &value, NULL, 0) == ERROR);
}


int doWrite_PLC_DigIn_25(int value)
{
return writeVarByCtIndex(ID_PLC_DigIn_25,  &value);
}


int addWrite_PLC_DigIn_25(int value)
{
return (prepareWriteVarByCtIndex(ID_PLC_DigIn_25, &value, NULL, 0) == ERROR);
}
