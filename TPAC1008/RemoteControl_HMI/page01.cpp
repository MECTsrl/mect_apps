...
/**
 * @brief this macro is used to set the PAGE01 style.
 * the syntax is html stylesheet-like
 */
#define SET_PAGE01_STYLE() { \
    QString mystyle; \
    ...
    ui(new Ui::page01)
{
    ...
    //SET_PAGE_STYLE();
    /* set the style described into the macro SET_PAGE01_STYLE */
    SET_PAGE01_STYLE();
...
void page01::reload()
{
     ...
     */
    writeVar("Selection",&sel);
}

/**
 * @brief This is the updateData member. The operation written here, are executed every REFRESH_MS milliseconds.
 */
void page01::updateData()
{
