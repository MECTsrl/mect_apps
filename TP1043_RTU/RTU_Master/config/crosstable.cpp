...
int doWrite_RTU_COMMAND(int16_t value)
{
return doWrite(ID_RTU_COMMAND,  &value);
}


int addWrite_RTU_COMMAND(int16_t value)
{
return addWrite(ID_RTU_COMMAND, &value);
}


int getStatus_RTU_COMMAND()
{
return getStatus(ID_RTU_COMMAND);
}


int doWrite_RTU_REPLY(int16_t value)
{
return doWrite(ID_RTU_REPLY,  &value);
}


int addWrite_RTU_REPLY(int16_t value)
{
return addWrite(ID_RTU_REPLY, &value);
}
