...
void page100::reload()
{
     ...
     */
    ui->qwtDial2->setScale( -2, + 10);
    ui->qwtDial2->setScaleMaxMajor(8);
    ui->qwtDial2->setScaleMaxMinor(6);
    ui->qwtDial1->setScale( 0, + 11);
    ui->qwtDial1->setScaleMaxMajor(8);
    ui->qwtDial1->setScaleMaxMinor(2);
    ui->qwtDial1->setValue(AnIn_1 / 1000);
    ui->qwtDial2->setValue(AnIn_2 / 1000);
}
