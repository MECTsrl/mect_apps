...
#include "main.h"
#include "page404.h"
#include "ui_page404.h"
#include "crosstable.h"

/**
 * @brief this macro is used to set the PAGE404 style.
 * the syntax is html stylesheet-like
 */
#define SET_PAGE404_STYLE() { \
    QString mystyle; \
 ...
 */
page404::page404(QWidget *parent) :
    page(parent),
    ui(new Ui::page404)
{
    ui->setupUi(this);
    ...
    //SET_PAGE_STYLE();
    /* set the style described into the macro SET_PAGE404_STYLE */
    SET_PAGE404_STYLE();
 ...
 */
void page404::changeEvent(QEvent * event)
{
