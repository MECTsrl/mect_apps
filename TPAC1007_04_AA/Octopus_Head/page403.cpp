...
#include "main.h"
#include "page403.h"
#include "ui_page403.h"
#include "crosstable.h"

/**
 * @brief this macro is used to set the PAGE403 style.
 * the syntax is html stylesheet-like
 */
#define SET_PAGE403_STYLE() { \
    QString mystyle; \
 ...
 */
page403::page403(QWidget *parent) :
    page(parent),
    ui(new Ui::page403)
{
    ui->setupUi(this);
    ...
    //SET_PAGE_STYLE();
    /* set the style described into the macro SET_PAGE403_STYLE */
    SET_PAGE403_STYLE();
 ...
 */
void page403::changeEvent(QEvent * event)
{
