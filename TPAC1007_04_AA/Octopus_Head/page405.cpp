...
#include "main.h"
#include "page405.h"
#include "ui_page405.h"
#include "crosstable.h"

/**
 * @brief this macro is used to set the PAGE405 style.
 * the syntax is html stylesheet-like
 */
#define SET_PAGE405_STYLE() { \
    QString mystyle; \
 ...
 */
page405::page405(QWidget *parent) :
    page(parent),
    ui(new Ui::page405)
{
    ui->setupUi(this);
    ...
    //SET_PAGE_STYLE();
    /* set the style described into the macro SET_PAGE405_STYLE */
    SET_PAGE405_STYLE();
 ...
 */
void page405::changeEvent(QEvent * event)
{
