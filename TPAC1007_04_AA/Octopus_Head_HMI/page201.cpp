...
#include "main.h"
#include "page201.h"
#include "ui_page201.h"

/**
 * @brief this macro is used to set the PAGE201 style.
 * the syntax is html stylesheet-like
 */
#define SET_PAGE201_STYLE() { \
    QString mystyle; \
 ...
 */
page201::page201(QWidget *parent) :
    page(parent),
    ui(new Ui::page201)
{
    ui->setupUi(this);
    ...
    //SET_PAGE_STYLE();
    /* set the style described into the macro SET_PAGE201_STYLE */
    SET_PAGE201_STYLE();
 ...
 */
void page201::changeEvent(QEvent * event)
{
