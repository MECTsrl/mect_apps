...
int prepareWrite_AUTOMATIC(int value);
 
#define ID_REPEAT 194
extern int REPEAT;
int doWrite_REPEAT(int value);
int prepareWrite_REPEAT(int value);
...
int prepareWrite_RESULT(int16_t value);
