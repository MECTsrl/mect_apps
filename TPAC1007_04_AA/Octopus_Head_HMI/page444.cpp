...
#include "main.h"
#include "page444.h"
#include "ui_page444.h"

/**
 * @brief this macro is used to set the PAGE444 style.
 * the syntax is html stylesheet-like
 */
#define SET_PAGE444_STYLE() { \
    QString mystyle; \
 ...
 */
page444::page444(QWidget *parent) :
    page(parent),
    ui(new Ui::page444)
{
    ui->setupUi(this);
    ...
    //SET_PAGE_STYLE();
    /* set the style described into the macro SET_PAGE444_STYLE */
    SET_PAGE444_STYLE();
 ...
 */
void page444::changeEvent(QEvent * event)
{
