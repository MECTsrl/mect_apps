...
#include "main.h"
#include "page434.h"
#include "ui_page434.h"

/**
 * @brief this macro is used to set the PAGE434 style.
 * the syntax is html stylesheet-like
 */
#define SET_PAGE434_STYLE() { \
    QString mystyle; \
 ...
 */
page434::page434(QWidget *parent) :
    page(parent),
    ui(new Ui::page434)
{
    ui->setupUi(this);
    ...
    //SET_PAGE_STYLE();
    /* set the style described into the macro SET_PAGE434_STYLE */
    SET_PAGE434_STYLE();
 ...
 */
void page434::changeEvent(QEvent * event)
{
