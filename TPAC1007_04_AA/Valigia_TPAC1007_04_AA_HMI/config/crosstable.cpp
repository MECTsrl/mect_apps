...
int doWrite_Valore_1(int16_t value)
{
return doWrite(ID_Valore_1,  &value);
}


int addWrite_Valore_1(int16_t value)
{
return addWrite(ID_Valore_1, &value);
}


int getStatus_Valore_1()
{
return getStatus(ID_Valore_1);
}


int doWrite_Bottone_1(int value)
{
return doWrite(ID_Bottone_1,  &value);
}


int addWrite_Bottone_1(int value)
{
return addWrite(ID_Bottone_1, &value);
}


int getStatus_Bottone_1()
{
return getStatus(ID_Bottone_1);
}


int doWrite_Bottone_2(int value)
{
return doWrite(ID_Bottone_2,  &value);
}


int addWrite_Bottone_2(int value)
{
return addWrite(ID_Bottone_2, &value);
}


int getStatus_Bottone_2()
{
return getStatus(ID_Bottone_2);
}
...
retval += readFromDb(ID_Valore_1, &Valore_1);
retval += readFromDb(ID_Bottone_1, &Bottone_1);
retval += readFromDb(ID_Bottone_2, &Bottone_2);
